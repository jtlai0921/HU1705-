...
mostCurrent._activity.setTitle((Object)("清單選項物件(ListView)"));
 BA.debugLineNum = 30;BA.debugLine="livSubject.AddSingleLine(1)";
Debug.ShouldStop(536870912);
mostCurrent._livsubject.AddSingleLine(BA.NumberToString(1));
 BA.debugLineNum = 31;BA.debugLine="livSubject.AddSingleLine(2)";
Debug.ShouldStop(1073741824);
mostCurrent._livsubject.AddSingleLine(BA.NumberToString(2));
 BA.debugLineNum = 32;BA.debugLine="livSubject.AddSingleLine(3)";
Debug.ShouldStop(-2147483648);
mostCurrent._livsubject.AddSingleLine(BA.NumberToString(3));
...
Debug.StartDebugging(mostCurrent.activityBA, 30653, new int[] {2}, "d67f4b4a-fe69-4e7d-b820-ff8bdcef6086");}
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 43;BA.debugLine="Sub livSubject_ItemClick (Position As Int, Value As Object)";
Debug.ShouldStop(1024);
 BA.debugLineNum = 44;BA.debugLine="Dim Temp As String";
Debug.ShouldStop(2048);
_temp = "";Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 45;BA.debugLine="Temp = \"你剛才點選的科目為：\" & CRLF";
Debug.ShouldStop(4096);
_temp = "你剛才點選的科目為："+anywheresoftware.b4a.keywords.Common.CRLF;Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 46;BA.debugLine="Temp = Temp & livSubject.GetItem(Position)";
