...
public anywheresoftware.b4a.objects.ImageViewWrapper _imageview3 = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"ImageView2",mostCurrent._imageview2,"ImageView3",mostCurrent._imageview3};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 28;BA.debugLine="Activity.Title=\"影像物件(ImageView)\"";
Debug.ShouldStop(134217728);
mostCurrent._activity.setTitle((Object)("影像物件(ImageView)"));
 BA.debugLineNum = 30;BA.debugLine="ImageView2.Bitmap = LoadBitmapSample(File.DirAssets, \"mis.jpg\", 100, 100)";
Debug.ShouldStop(536870912);
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"mis.jpg",(int) (100),(int) (100)).getObject()));
 BA.debugLineNum = 32;BA.debugLine="ImageView3.Bitmap = LoadBitmap(File.DirAssets, \"mis.jpg\")";
Debug.ShouldStop(-2147483648);
mostCurrent._imageview3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"mis.jpg").getObject()));
...
Debug.StartDebugging(mostCurrent.activityBA, 29780, new int[] {2}, "8ca0e838-7981-4b22-82ee-7ce43d26d47e");}
