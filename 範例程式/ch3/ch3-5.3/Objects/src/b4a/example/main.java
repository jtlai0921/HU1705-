...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 27;BA.debugLine="Activity.Title=\"彈跳式訊息方塊(ToastMessageShow)\"";
Debug.ShouldStop(67108864);
mostCurrent._activity.setTitle((Object)("彈跳式訊息方塊(ToastMessageShow)"));
...
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="ToastMessageShow (\"考試時間已結束!3秒後系統自動關閉!!\",True)";
Debug.ShouldStop(32);
anywheresoftware.b4a.keywords.Common.ToastMessageShow("考試時間已結束!3秒後系統自動關閉!!",anywheresoftware.b4a.keywords.Common.True);
...
Debug.StartDebugging(mostCurrent.activityBA, 18340, new int[] {2}, "2c6a22ea-eed6-409c-87f9-cc04627c613d");}
