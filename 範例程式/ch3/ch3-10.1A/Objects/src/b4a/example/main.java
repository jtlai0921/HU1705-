...
mostCurrent._activity.setTitle((Object)("清單選項物件(ListView)"));
 BA.debugLineNum = 30;BA.debugLine="livSubject.AddSingleLine(\"程式設計\")";
Debug.ShouldStop(536870912);
mostCurrent._livsubject.AddSingleLine("程式設計");
 BA.debugLineNum = 31;BA.debugLine="livSubject.AddSingleLine(\"資料庫系統\")";
Debug.ShouldStop(1073741824);
mostCurrent._livsubject.AddSingleLine("資料庫系統");
 BA.debugLineNum = 32;BA.debugLine="livSubject.AddSingleLine(\"資料結構\")";
Debug.ShouldStop(-2147483648);
mostCurrent._livsubject.AddSingleLine("資料結構");
 BA.debugLineNum = 33;BA.debugLine="livSubject.AddSingleLine(\"系統分析\")";
Debug.ShouldStop(1);
mostCurrent._livsubject.AddSingleLine("系統分析");
 BA.debugLineNum = 34;BA.debugLine="livSubject.AddSingleLine(\"計算機概論\")";
Debug.ShouldStop(2);
mostCurrent._livsubject.AddSingleLine("計算機概論");
 BA.debugLineNum = 35;BA.debugLine="livSubject.AddSingleLine(\"數位學習\")";
Debug.ShouldStop(4);
mostCurrent._livsubject.AddSingleLine("數位學習");
...
Debug.StartDebugging(mostCurrent.activityBA, 46606, new int[] {2}, "914897f1-e545-4821-8a35-b13210b02213");}
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 47;BA.debugLine="Sub livSubject_ItemClick (Position As Int, Value As Object)";
Debug.ShouldStop(16384);
 BA.debugLineNum = 48;BA.debugLine="Dim Temp As String";
Debug.ShouldStop(32768);
_temp = "";Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 49;BA.debugLine="Temp = \"你剛才點選的科目為：\" & CRLF";
Debug.ShouldStop(65536);
_temp = "你剛才點選的科目為："+anywheresoftware.b4a.keywords.Common.CRLF;Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 50;BA.debugLine="Temp = Temp & livSubject.GetItem(Position)";
Debug.ShouldStop(131072);
_temp = _temp+BA.ObjectToString(mostCurrent._livsubject.GetItem(_position));Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 51;BA.debugLine="lblResult.Text =Temp";
