...
public anywheresoftware.b4a.objects.SpinnerWrapper _spnsubject = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"lblResult",mostCurrent._lblresult,"spnSubject",mostCurrent._spnsubject};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 28;BA.debugLine="Activity.Title=\"下拉式清單物件(Spinner)\"";
Debug.ShouldStop(134217728);
mostCurrent._activity.setTitle((Object)("下拉式清單物件(Spinner)"));
 BA.debugLineNum = 29;BA.debugLine="spnSubject.Add(\"程式設計\")";
Debug.ShouldStop(268435456);
mostCurrent._spnsubject.Add("程式設計");
 BA.debugLineNum = 30;BA.debugLine="spnSubject.Add(\"資料庫系統\")";
Debug.ShouldStop(536870912);
mostCurrent._spnsubject.Add("資料庫系統");
 BA.debugLineNum = 31;BA.debugLine="spnSubject.Add(\"資料結構\")";
Debug.ShouldStop(1073741824);
mostCurrent._spnsubject.Add("資料結構");
 BA.debugLineNum = 32;BA.debugLine="spnSubject.Add(\"系統分析\")";
Debug.ShouldStop(-2147483648);
mostCurrent._spnsubject.Add("系統分析");
 BA.debugLineNum = 33;BA.debugLine="spnSubject.Add(\"計算機概論\")";
Debug.ShouldStop(1);
mostCurrent._spnsubject.Add("計算機概論");
 BA.debugLineNum = 34;BA.debugLine="spnSubject.Add(\"數位學習\")";
Debug.ShouldStop(2);
...
Debug.StartDebugging(mostCurrent.activityBA, 29437, new int[] {2}, "d87ccd95-090f-438d-a8de-3701eba0a9e6");}
...
mostCurrent._lblresult = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim spnSubject As Spinner";
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 45;BA.debugLine="Sub spnSubject_ItemClick (Position As Int, Value As Object)";
Debug.ShouldStop(4096);
 BA.debugLineNum = 46;BA.debugLine="Dim Temp As String";
Debug.ShouldStop(8192);
_temp = "";Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 47;BA.debugLine="Temp = \"你喜歡的科目為：\" & CRLF";
Debug.ShouldStop(16384);
_temp = "你喜歡的科目為："+anywheresoftware.b4a.keywords.Common.CRLF;Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 48;BA.debugLine="Temp = Temp & spnSubject.SelectedItem";
Debug.ShouldStop(32768);
_temp = _temp+mostCurrent._spnsubject.getSelectedItem();Debug.locals.put("Temp", _temp);
