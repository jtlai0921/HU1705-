...
public anywheresoftware.b4a.keywords.Common __c = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"圖片按鈕(Picture Button)\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("圖片按鈕(Picture Button)"));
...
Debug.StartDebugging(mostCurrent.activityBA, 20795, new int[] {2}, "6e955376-7648-4bff-89ff-1e3f1fc1e5a2");}
