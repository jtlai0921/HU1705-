...
public anywheresoftware.b4a.objects.LabelWrapper _lblresult = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"btnRun1",mostCurrent._btnrun1,"btnRun2",mostCurrent._btnrun2,"lblResult",mostCurrent._lblresult};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"利用「For Each」迴圈\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("利用「For Each」迴圈"));
...
int _i = 0;
int _sum = 0;
 BA.debugLineNum = 40;BA.debugLine="Sub btnRun1_Click   'For/Next寫法";
Debug.ShouldStop(128);
 BA.debugLineNum = 42;BA.debugLine="Dim A() As Int";
Debug.ShouldStop(512);
_a = new int[(int) (0)];
;Debug.locals.put("A", _a);
 BA.debugLineNum = 43;BA.debugLine="A=Array As Int (60, 70, 80, 85, 90, 100)";
Debug.ShouldStop(1024);
_a = new int[]{(int) (60),(int) (70),(int) (80),(int) (85),(int) (90),(int) (100)};Debug.locals.put("A", _a);
 BA.debugLineNum = 44;BA.debugLine="Dim i=0,sum As Int = 0";
Debug.ShouldStop(2048);
_i = (int) (0);Debug.locals.put("i", _i);Debug.locals.put("i", _i);
_sum = (int) (0);Debug.locals.put("sum", _sum);Debug.locals.put("sum", _sum);
 BA.debugLineNum = 46;BA.debugLine="For i = 0 To 5";
Debug.ShouldStop(8192);
{
final int step19 = 1;
final int limit19 = (int) (5);
for (_i = (int) (0); (step19 > 0 && _i <= limit19) || (step19 < 0 && _i >= limit19); _i = ((int)(0 + _i + step19))) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 47;BA.debugLine="sum = sum + A(i)";
Debug.ShouldStop(16384);
_sum = (int) (_sum+_a[_i]);Debug.locals.put("sum", _sum);
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 50;BA.debugLine="lblResult.Text =sum";
...
int[] _a = null;
int _sum = 0;
Object _arrvalue = null;
 BA.debugLineNum = 52;BA.debugLine="Sub btnRun2_Click   'For Each/Next寫法";
Debug.ShouldStop(524288);
 BA.debugLineNum = 54;BA.debugLine="Dim A() As Int";
Debug.ShouldStop(2097152);
_a = new int[(int) (0)];
;Debug.locals.put("A", _a);
 BA.debugLineNum = 55;BA.debugLine="A=Array As Int (60, 70, 80, 85, 90, 100)";
Debug.ShouldStop(4194304);
_a = new int[]{(int) (60),(int) (70),(int) (80),(int) (85),(int) (90),(int) (100)};Debug.locals.put("A", _a);
 BA.debugLineNum = 56;BA.debugLine="Dim sum As Int = 0";
Debug.ShouldStop(8388608);
_sum = (int) (0);Debug.locals.put("sum", _sum);Debug.locals.put("sum", _sum);
 BA.debugLineNum = 58;BA.debugLine="For Each arrValue In A";
Debug.ShouldStop(33554432);
final int[] group28 = _a;
final int groupLen28 = group28.length;
for (int index28 = 0;index28 < groupLen28 ;index28++){
_arrvalue = (Object)(group28[index28]);Debug.locals.put("arrvalue", _arrvalue);
Debug.locals.put("arrvalue", _arrvalue);
 BA.debugLineNum = 59;BA.debugLine="sum = sum + arrValue";
Debug.ShouldStop(67108864);
_sum = (int) (_sum+(double)(BA.ObjectToNumber(_arrvalue)));Debug.locals.put("sum", _sum);
 }
Debug.locals.put("arrvalue", _arrvalue);
;
 BA.debugLineNum = 62;BA.debugLine="lblResult.Text =sum";
Debug.ShouldStop(536870912);
mostCurrent._lblresult.setText((Object)(_sum));
...
Debug.StartDebugging(mostCurrent.activityBA, 42988, new int[] {2}, "d08148d8-a864-4517-aab5-c9f358d3d362");}
