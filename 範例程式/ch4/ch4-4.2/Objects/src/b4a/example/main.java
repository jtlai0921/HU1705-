...
public anywheresoftware.b4a.objects.ButtonWrapper _btnrun = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"btnRun",mostCurrent._btnrun,"lblResult",mostCurrent._lblresult,"Num",_num};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"全域性變數(global variable)\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("全域性變數(global variable)"));
...
Debug.ShouldStop(128);
 BA.debugLineNum = 42;BA.debugLine="Num= 50";
Debug.ShouldStop(512);
_num = (int) (50);
 BA.debugLineNum = 43;BA.debugLine="CallMySub     '呼叫副程式(區塊程序)";
...
public static String  _callmysub() throws Exception{
		Debug.PushSubsStack("CallMySub (main) ","main",0,mostCurrent.activityBA,mostCurrent);
try {
 BA.debugLineNum = 46;BA.debugLine="Sub CallMySub()   '被呼叫的副程式";
Debug.ShouldStop(8192);
 BA.debugLineNum = 48;BA.debugLine="lblResult.text=\"Num=\" & Num";
Debug.ShouldStop(32768);
mostCurrent._lblresult.setText((Object)("Num="+BA.NumberToString(_num)));
...
Debug.StartDebugging(mostCurrent.activityBA, 14119, new int[] {2}, "32c9b909-c7dc-4085-bf8d-787f5a6207a5");}
 ...
 //BA.debugLineNum = 22;BA.debugLine="Dim Num As Int";
_num = 0;
