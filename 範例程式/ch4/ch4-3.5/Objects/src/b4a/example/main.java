...
public anywheresoftware.b4a.objects.ButtonWrapper _btnrun3 = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"btnRun1",mostCurrent._btnrun1,"btnRun2",mostCurrent._btnrun2,"btnRun3",mostCurrent._btnrun3,"lblResult",mostCurrent._lblresult};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 30;BA.debugLine="Activity.Title=\"字串連結運算子的應用\"";
Debug.ShouldStop(536870912);
mostCurrent._activity.setTitle((Object)("字串連結運算子的應用"));
...
Debug.ShouldStop(256);
 BA.debugLineNum = 42;BA.debugLine="Dim R As Int = 5";
Debug.ShouldStop(512);
_r = (int) (5);Debug.locals.put("R", _r);Debug.locals.put("R", _r);
 BA.debugLineNum = 43;BA.debugLine="lblResult.Text = \"圓的半徑是：\" & R";
Debug.ShouldStop(1024);
mostCurrent._lblresult.setText((Object)("圓的半徑是："+BA.NumberToString(_r)));
...
try {
 BA.debugLineNum = 45;BA.debugLine="Sub btnRun2_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 46;BA.debugLine="lblResult.Text = \"圓面積的公式：\" & \"圓周率*半徑^2\"";
Debug.ShouldStop(8192);
mostCurrent._lblresult.setText((Object)("圓面積的公式："+"圓周率*半徑^2"));
...
int _r = 0;
float _pi = 0f;
 BA.debugLineNum = 48;BA.debugLine="Sub btnRun3_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 49;BA.debugLine="Dim R As Int=5";
Debug.ShouldStop(65536);
_r = (int) (5);Debug.locals.put("R", _r);Debug.locals.put("R", _r);
 BA.debugLineNum = 50;BA.debugLine="Dim PI As Float= 3.14";
Debug.ShouldStop(131072);
_pi = (float) (3.14);Debug.locals.put("PI", _pi);Debug.locals.put("PI", _pi);
 BA.debugLineNum = 51;BA.debugLine="lblResult.Text = \"圓面積是：\" & (PI * Power(R,2))";
Debug.ShouldStop(262144);
mostCurrent._lblresult.setText((Object)("圓面積是："+BA.NumberToString((_pi*anywheresoftware.b4a.keywords.Common.Power(_r,2)))));
...
Debug.StartDebugging(mostCurrent.activityBA, 43738, new int[] {2}, "49830285-c095-4746-9f2c-abf16d49a029");}
...
mostCurrent._btnrun2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim btnRun3 As Button";
