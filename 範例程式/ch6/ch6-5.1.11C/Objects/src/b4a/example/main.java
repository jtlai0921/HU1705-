...
public anywheresoftware.b4a.objects.ButtonWrapper _btnrun = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"btnRun",mostCurrent._btnrun,"edtString",mostCurrent._edtstring};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 28;BA.debugLine="Activity.Title=\"由ID判定男生或女生\"";
Debug.ShouldStop(134217728);
mostCurrent._activity.setTitle((Object)("由ID判定男生或女生"));
...
_temp = "";Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 44;BA.debugLine="Str = edtString.Text";
Debug.ShouldStop(2048);
_str = mostCurrent._edtstring.getText();Debug.locals.put("Str", _str);
 BA.debugLineNum = 45;BA.debugLine="Temp = Str.Substring2(1,2)";
Debug.ShouldStop(4096);
_temp = _str.substring((int) (1),(int) (2));Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 46;BA.debugLine="If (Temp=\"1\") Then";
Debug.ShouldStop(8192);
if (((_temp).equals("1"))) { 
 BA.debugLineNum = 47;BA.debugLine="Msgbox(\"男生\",\"顯示結果\")";
Debug.ShouldStop(16384);
anywheresoftware.b4a.keywords.Common.Msgbox("男生","顯示結果",mostCurrent.activityBA);
 }else {
 BA.debugLineNum = 49;BA.debugLine="Msgbox(\"女生\",\"顯示結果\")";
Debug.ShouldStop(65536);
anywheresoftware.b4a.keywords.Common.Msgbox("女生","顯示結果",mostCurrent.activityBA);
 };
 };
...
Debug.StartDebugging(mostCurrent.activityBA, 10112, new int[] {2}, "2f2c95fc-2df7-46dd-a7ec-9c4b4b414f52");}
