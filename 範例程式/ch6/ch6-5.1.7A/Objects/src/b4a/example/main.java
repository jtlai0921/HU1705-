...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"計算使用者輸入的內容字數\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("計算使用者輸入的內容字數"));
...
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入字串資料哦!","產生錯誤...",mostCurrent.activityBA);
 ...
 BA.debugLineNum = 44;BA.debugLine="Dim Str1 As String";
...
_result = 0;Debug.locals.put("Result", _result);
 BA.debugLineNum = 46;BA.debugLine="Str1 = edtString.Text";
Debug.ShouldStop(8192);
_str1 = mostCurrent._edtstring.getText();Debug.locals.put("Str1", _str1);
 BA.debugLineNum = 47;BA.debugLine="Result = Str1.Length";
Debug.ShouldStop(16384);
_result = _str1.length();Debug.locals.put("Result", _result);
 BA.debugLineNum = 48;BA.debugLine="lblResult.Text =Result";
...
Debug.StartDebugging(mostCurrent.activityBA, 36704, new int[] {2}, "cc6a1006-493c-4031-bd1b-160c9a2c9e05");}
