...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 28;BA.debugLine="Activity.Title=\"設計數字三角形\"";
...
_str = mostCurrent._edtstring.getText();Debug.locals.put("Str", _str);
 BA.debugLineNum = 46;BA.debugLine="For i = 0 To Str.Length-1";
Debug.ShouldStop(8192);
{
final int step21 = 1;
final int limit21 = (int) (_str.length()-1);
for (_i = (int) (0); (step21 > 0 && _i <= limit21) || (step21 < 0 && _i >= limit21); _i = ((int)(0 + _i + step21))) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 47;BA.debugLine="Temp=Temp & Str.Substring2(0,i+1) & CRLF";
Debug.ShouldStop(16384);
_temp = _temp+_str.substring((int) (0),(int) (_i+1))+anywheresoftware.b4a.keywords.Common.CRLF;Debug.locals.put("Temp", _temp);
 }
}Debug.locals.put("i", _i);
;
...
Debug.StartDebugging(mostCurrent.activityBA, 35092, new int[] {2}, "cca0eea0-1b98-45bd-aea0-8fe31c868504");}
