...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"由ID判定稱呼\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("由ID判定稱呼"));
...
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入字串資料哦!","產生錯誤...",mostCurrent.activityBA);
 ...
 BA.debugLineNum = 44;BA.debugLine="Dim Str,Result As String";
...
_str = mostCurrent._edtstring.getText();Debug.locals.put("Str", _str);
 BA.debugLineNum = 46;BA.debugLine="Result = Str.CharAt(1)";
Debug.ShouldStop(8192);
_result = BA.ObjectToString(_str.charAt((int) (1)));Debug.locals.put("Result", _result);
 BA.debugLineNum = 47;BA.debugLine="If (Result=\"1\") Then";
Debug.ShouldStop(16384);
if (((_result).equals("1"))) { 
 BA.debugLineNum = 48;BA.debugLine="lblResult.Text =\"先生 您好!\"";
Debug.ShouldStop(32768);
mostCurrent._lblresult.setText((Object)("先生 您好!"));
 }else {
 BA.debugLineNum = 50;BA.debugLine="lblResult.Text =\"小姐 您好!\"";
Debug.ShouldStop(131072);
mostCurrent._lblresult.setText((Object)("小姐 您好!"));
 };
 };
...
Debug.StartDebugging(mostCurrent.activityBA, 26576, new int[] {2}, "7cf3f4ec-c6c6-4287-8648-984fbab7f332");}
