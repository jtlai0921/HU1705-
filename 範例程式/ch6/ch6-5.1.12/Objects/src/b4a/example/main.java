...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"大寫轉成小寫\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("大寫轉成小寫"));
...
_str = mostCurrent._edtstring.getText();Debug.locals.put("Str", _str);
 BA.debugLineNum = 46;BA.debugLine="lblResult.Text =Str.ToLowerCase";
Debug.ShouldStop(8192);
mostCurrent._lblresult.setText((Object)(_str.toLowerCase()));
 };
...
Debug.StartDebugging(mostCurrent.activityBA, 27043, new int[] {2}, "fb5e37b1-49d5-467e-8b08-3cb91976e7a4");}
