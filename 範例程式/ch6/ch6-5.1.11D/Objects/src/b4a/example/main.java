...
public anywheresoftware.b4a.objects.EditTextWrapper _edtchar = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"btnRun",mostCurrent._btnrun,"edtChar",mostCurrent._edtchar,"edtString",mostCurrent._edtstring};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"計算某些字出現的次數\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("計算某些字出現的次數"));
...
Debug.ShouldStop(128);
 BA.debugLineNum = 41;BA.debugLine="If edtString.Text=\"\" OR edtChar.Text=\"\"  Then";
Debug.ShouldStop(256);
if ((mostCurrent._edtstring.getText()).equals("") || (mostCurrent._edtchar.getText()).equals("")) { 
 BA.debugLineNum = 42;BA.debugLine="Msgbox(\"您尚未輸入一串字哦!\",\"產生錯誤...\")";
Debug.ShouldStop(512);
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入一串字哦!","產生錯誤...",mostCurrent.activityBA);
 }else {
 BA.debugLineNum = 44;BA.debugLine="Dim Str,word,Temp  As String";
Debug.ShouldStop(2048);
_str = "";Debug.locals.put("Str", _str);
_word = "";Debug.locals.put("word", _word);
_temp = "";Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 45;BA.debugLine="Dim i,t As Int";
Debug.ShouldStop(4096);
_i = 0;Debug.locals.put("i", _i);
_t = 0;Debug.locals.put("t", _t);
 BA.debugLineNum = 46;BA.debugLine="Str = edtString.Text";
Debug.ShouldStop(8192);
_str = mostCurrent._edtstring.getText();Debug.locals.put("Str", _str);
 BA.debugLineNum = 47;BA.debugLine="word=edtChar.Text";
Debug.ShouldStop(16384);
_word = mostCurrent._edtchar.getText();Debug.locals.put("word", _word);
 BA.debugLineNum = 48;BA.debugLine="For i = 0 To Str.Length-1";
Debug.ShouldStop(32768);
{
final int step23 = 1;
final int limit23 = (int) (_str.length()-1);
for (_i = (int) (0); (step23 > 0 && _i <= limit23) || (step23 < 0 && _i >= limit23); _i = ((int)(0 + _i + step23))) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 49;BA.debugLine="If(Str.Substring2(i,i+1) = word) Then";
Debug.ShouldStop(65536);
if (((_str.substring(_i,(int) (_i+1))).equals(_word))) { 
 BA.debugLineNum = 50;BA.debugLine="t=t+1";
Debug.ShouldStop(131072);
_t = (int) (_t+1);Debug.locals.put("t", _t);
 };
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 53;BA.debugLine="Temp=Str & \"字串中共有：\" & t & \"個\" & word & \"字元\"";
Debug.ShouldStop(1048576);
_temp = _str+"字串中共有："+BA.NumberToString(_t)+"個"+_word+"字元";Debug.locals.put("Temp", _temp);
 BA.debugLineNum = 54;BA.debugLine="Msgbox(Temp,\"顯示結果\")";
...
Debug.StartDebugging(mostCurrent.activityBA, 15682, new int[] {2}, "f6201875-ab45-4de6-9905-1ef4b685e5b6");}
...
mostCurrent._btnrun = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Dim edtChar As EditText";
