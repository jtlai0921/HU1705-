...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 27;BA.debugLine="Activity.Title=\"第一支主程式呼叫「副程式」\"";
Debug.ShouldStop(67108864);
mostCurrent._activity.setTitle((Object)("第一支主程式呼叫「副程式」"));
...
Debug.ShouldStop(32);
 BA.debugLineNum = 40;BA.debugLine="CallMySub        '呼叫副程式";
...
try {
 BA.debugLineNum = 42;BA.debugLine="Sub CallMySub()     '被呼叫的副程式";
Debug.ShouldStop(512);
 BA.debugLineNum = 44;BA.debugLine="Msgbox(\"副程式測試ok!\",\"測試結果\")";
Debug.ShouldStop(2048);
anywheresoftware.b4a.keywords.Common.Msgbox("副程式測試ok!","測試結果",mostCurrent.activityBA);
...
Debug.StartDebugging(mostCurrent.activityBA, 7773, new int[] {2}, "ee40d8cf-f11f-4826-915b-27385f8c8d60");}
