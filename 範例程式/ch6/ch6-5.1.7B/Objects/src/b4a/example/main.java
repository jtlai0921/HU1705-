...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"檢查身份證字號的字數\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("檢查身份證字號的字數"));
...
Debug.ShouldStop(128);
 BA.debugLineNum = 41;BA.debugLine="If edtString.Text=\"\" Then";
...
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入字串資料哦!","產生錯誤...",mostCurrent.activityBA);
 ...
 BA.debugLineNum = 44;BA.debugLine="Dim Str As String";
...
_str = mostCurrent._edtstring.getText();Debug.locals.put("Str", _str);
 BA.debugLineNum = 47;BA.debugLine="Result = Str.Length";
Debug.ShouldStop(16384);
_result = _str.length();Debug.locals.put("Result", _result);
 BA.debugLineNum = 48;BA.debugLine="If (Result<> 10) Then";
Debug.ShouldStop(32768);
if ((_result!=10)) { 
 BA.debugLineNum = 49;BA.debugLine="lblResult.Text =\"ID字數錯誤(未10位)！\"";
Debug.ShouldStop(65536);
mostCurrent._lblresult.setText((Object)("ID字數錯誤(未10位)！"));
 }else {
 BA.debugLineNum = 51;BA.debugLine="lblResult.Text =\"ID字數正確！\"";
Debug.ShouldStop(262144);
mostCurrent._lblresult.setText((Object)("ID字數正確！"));
 };
 };
...
Debug.StartDebugging(mostCurrent.activityBA, 17582, new int[] {2}, "bffc99ed-5afd-439d-8b10-81f4d8a3b600");}
