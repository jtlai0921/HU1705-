...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 28;BA.debugLine="Activity.Title=\"傳值呼叫(Call By Value)\"";
...
Debug.ShouldStop(64);
 BA.debugLineNum = 40;BA.debugLine="Dim X, Y As Int";
Debug.ShouldStop(128);
_x = 0;Debug.locals.put("X", _x);
_y = 0;Debug.locals.put("Y", _y);
 BA.debugLineNum = 41;BA.debugLine="X = 5";
Debug.ShouldStop(256);
_x = (int) (5);Debug.locals.put("X", _x);
 BA.debugLineNum = 42;BA.debugLine="Y = 10";
Debug.ShouldStop(512);
_y = (int) (10);Debug.locals.put("Y", _y);
 BA.debugLineNum = 43;BA.debugLine="CallByValue(X, Y)";
Debug.ShouldStop(1024);
_callbyvalue(_x,_y);
 BA.debugLineNum = 44;BA.debugLine="lblResult.Text = \"X=\" & X & \" Y=\" & Y";
...
public static String  _callbyvalue(int _a,int _b) throws Exception{
		Debug.PushSubsStack("CallByValue (main) ","main",0,mostCurrent.activityBA,mostCurrent);
try {
Debug.locals.put("A", _a);
Debug.locals.put("B", _b);
 BA.debugLineNum = 46;BA.debugLine="Sub CallByValue(A As Int, B As Int)";
Debug.ShouldStop(8192);
 BA.debugLineNum = 47;BA.debugLine="A = 15";
Debug.ShouldStop(16384);
_a = (int) (15);Debug.locals.put("A", _a);
 BA.debugLineNum = 48;BA.debugLine="B = 30";
...
Debug.StartDebugging(mostCurrent.activityBA, 17125, new int[] {2}, "bed65b77-a3c4-4c5d-a269-290c152e72d8");}
