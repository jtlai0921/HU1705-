...
_b = anywheresoftware.b4a.keywords.Common.LoadBitmap(mostCurrent._httputilsservice._tempfolder,BA.ObjectToString(_successfulurls.Get((Object)(_url))));
...
_in = anywheresoftware.b4a.keywords.Common.File.OpenInput(mostCurrent._httputilsservice._tempfolder,BA.ObjectToString(_successfulurls.Get((Object)(_url))));
...
if (true) return anywheresoftware.b4a.keywords.Common.File.GetText(mostCurrent._httputilsservice._tempfolder,BA.ObjectToString(_successfulurls.Get((Object)(_url))));
