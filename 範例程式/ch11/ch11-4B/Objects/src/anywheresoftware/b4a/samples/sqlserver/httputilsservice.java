...
public class httputilsservice extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "anywheresoftware.b4a.samples.sqlserver", "anywheresoftware.b4a.samples.sqlserver.httputilsservice");
            try {
        ...
        if (BA.shellMode) {
			processBA.raiseEvent2(null, true, "CREATE", true, "anywheresoftware.b4a.samples.sqlserver.httputilsservice", processBA, _service);
		}
...
String _link = "";
 //BA.debugLineNum = 105;BA.debugLine="Sub HandleError(TaskId As Int, Reason As String)";
 //BA.debugLineNum = 106;BA.debugLine="Dim link As String";
_link = "";
 //BA.debugLineNum = 107;BA.debugLine="link = taskToRequest.Get(TaskId)";
_link = BA.ObjectToString(_tasktorequest.Get((Object)(_taskid)));
 //BA.debugLineNum = 108;BA.debugLine="Log(\"Error. Url=\" & link & \" Message=\" & Reason)";
...
public static String  _hc_responseerror(anywheresoftware.b4a.http.HttpClientWrapper.HttpResponeWrapper _response,String _reason,int _statuscode,int _taskid) throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Sub hc_ResponseError (Response As HttpResponse, Reason As String, StatusCode As Int, TaskId As Int)";
 //BA.debugLineNum = 96;BA.debugLine="countWorking = countWorking - 1";
_countworking = (int) (_countworking-1);
 //BA.debugLineNum = 97;BA.debugLine="finishTasks = finishTasks + 1";
_finishtasks = (int) (_finishtasks+1);
 //BA.debugLineNum = 98;BA.debugLine="HandleError(TaskId, Reason)";
_handleerror(_taskid,_reason);
 //BA.debugLineNum = 99;BA.debugLine="If Response <> Null Then";
if (_response!= null) { 
 //BA.debugLineNum = 100;BA.debugLine="Log(Response.GetString(\"UTF8\"))";
anywheresoftware.b4a.keywords.Common.Log(_response.GetString("UTF8"));
 //BA.debugLineNum = 101;BA.debugLine="Response.Release";
_response.Release();
 };
 //BA.debugLineNum = 103;BA.debugLine="ProcessNextTask";
_processnexttask();
...
public static String  _hc_responsesuccess(anywheresoftware.b4a.http.HttpClientWrapper.HttpResponeWrapper _response,int _taskid) throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Sub hc_ResponseSuccess (Response As HttpResponse, TaskId As Int)";
 //BA.debugLineNum = 78;BA.debugLine="Response.GetAsynchronously(\"response\", File.OpenOutput(TempFolder, TaskId, False), _ 		True, TaskId)";
...
_hcisinitialized = false;
 //BA.debugLineNum = 20;BA.debugLine="Dim init As Boolean";
_init = false;
 //BA.debugLineNum = 21;BA.debugLine="init = True";
_init = anywheresoftware.b4a.keywords.Common.True;
...
anywheresoftware.b4a.http.HttpClientWrapper.HttpUriRequestWrapper _req = null;
 //BA.debugLineNum = 43;BA.debugLine="Sub ProcessNextTask";
 //BA.debugLineNum = 44;BA.debugLine="If finishTasks >= HttpUtils.Tasks.Size Then";
if (_finishtasks>=mostCurrent._httputils._tasks.getSize()) { 
 //BA.debugLineNum = 45;BA.debugLine="HttpUtils.Working = False";
mostCurrent._httputils._working = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 46;BA.debugLine="HttpUtils.Complete = True";
mostCurrent._httputils._complete = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 48;BA.debugLine="If HttpUtils.CallbackJobDoneSub <> \"\" Then";
if ((mostCurrent._httputils._callbackjobdonesub).equals("") == false) { 
 //BA.debugLineNum = 49;BA.debugLine="CallSub2(HttpUtils.CallbackActivity, HttpUtils.CallbackJobDoneSub, HttpUtils.Job)";
anywheresoftware.b4a.keywords.Common.CallSubNew2(processBA,(Object)(mostCurrent._httputils._callbackactivity),mostCurrent._httputils._callbackjobdonesub,(Object)(mostCurrent._httputils._job));
 ...
 //BA.debugLineNum = 52;BA.debugLine="If HttpUtils.Working = False Then";
if (mostCurrent._httputils._working==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 53;BA.debugLine="StopService(\"\")";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(""));
 };
 //BA.debugLineNum = 55;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 57;BA.debugLine="If task >= HttpUtils.Tasks.Size Then Return";
if (_task>=mostCurrent._httputils._tasks.getSize()) { 
if (true) return "";};
 //BA.debugLineNum = 58;BA.debugLine="Dim link As String";
_link = "";
 //BA.debugLineNum = 59;BA.debugLine="link = HttpUtils.Tasks.Get(task)";
_link = BA.ObjectToString(mostCurrent._httputils._tasks.Get(_task));
 //BA.debugLineNum = 60;BA.debugLine="Dim req As HttpRequest";
_req = new anywheresoftware.b4a.http.HttpClientWrapper.HttpUriRequestWrapper();
 //BA.debugLineNum = 61;BA.debugLine="If Post Then";
if (_post) { 
 //BA.debugLineNum = 62;BA.debugLine="If PostInputStream.IsInitialized Then";
if (_postinputstream.IsInitialized()) { 
 //BA.debugLineNum = 63;BA.debugLine="req.InitializePost(link, PostInputStream, PostLength)";
_req.InitializePost(_link,(java.io.InputStream)(_postinputstream.getObject()),_postlength);
 }else {
 //BA.debugLineNum = 65;BA.debugLine="req.InitializePost2(link, PostBytes)";
...
_req.InitializeGet(_link);
 ...
 //BA.debugLineNum = 71;BA.debugLine="countWorking = countWorking + 1";
_countworking = (int) (_countworking+1);
 //BA.debugLineNum = 72;BA.debugLine="taskToRequest.Put(task, link)";
_tasktorequest.Put((Object)(_task),(Object)(_link));
 //BA.debugLineNum = 73;BA.debugLine="hc.Execute(req, task)";
_hc.Execute(processBA,_req,_task);
 //BA.debugLineNum = 74;BA.debugLine="task = task + 1";
_task = (int) (_task+1);
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="If init = False Then Process_Globals";
if (_init==anywheresoftware.b4a.keywords.Common.False) { 
_process_globals();};
 //BA.debugLineNum = 25;BA.debugLine="If TempFolder = \"\" Then TempFolder = File.DirInternalCache";
if ((_tempfolder).equals("")) { 
_tempfolder = anywheresoftware.b4a.keywords.Common.File.getDirInternalCache();};
 //BA.debugLineNum = 26;BA.debugLine="If hcIsInitialized = False Then";
if (_hcisinitialized==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 27;BA.debugLine="hc.Initialize(\"hc\")";
_hc.Initialize("hc");
 //BA.debugLineNum = 28;BA.debugLine="hcIsInitialized = True";
...
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Sub Service_Destroy";
 //BA.debugLineNum = 111;BA.debugLine="HttpUtils.Working = False";
mostCurrent._httputils._working = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 112;BA.debugLine="End Sub";
return "";
}
public static String  _service_start() throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub Service_Start";
 //BA.debugLineNum = 33;BA.debugLine="If HttpUtils.Tasks.IsInitialized = False Then Return";
if (mostCurrent._httputils._tasks.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 34;BA.debugLine="taskToRequest.Initialize";
_tasktorequest.Initialize();
 //BA.debugLineNum = 35;BA.debugLine="finishTasks = 0";
_finishtasks = (int) (0);
 //BA.debugLineNum = 36;BA.debugLine="task = 0";
_task = (int) (0);
 //BA.debugLineNum = 37;BA.debugLine="countWorking = 0";
_countworking = (int) (0);
 //BA.debugLineNum = 38;BA.debugLine="Do While task < HttpUtils.Tasks.Size";
while (_task<mostCurrent._httputils._tasks.getSize()) {
 //BA.debugLineNum = 39;BA.debugLine="ProcessNextTask";
_processnexttask();
 //BA.debugLineNum = 40;BA.debugLine="If countWorking >= maxTasks Then Exit";
