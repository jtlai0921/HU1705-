...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 34;BA.debugLine="Activity.LoadLayout(\"Main\")                                '使用「Main(版面配置檔)」來輸出";
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 35;BA.debugLine="Activity.Title =\"B4A連結SQL_Server(檢查是否為會員)V3.0\"    '本頁面的標題名稱";
mostCurrent._activity.setTitle((Object)("B4A連結SQL_Server(檢查是否為會員)V3.0"));
 //BA.debugLineNum = 36;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 37;BA.debugLine="HttpUtils.CallbackActivity = \"Myebook\"      '設定回覆的活動頁面名稱";
mostCurrent._httputils._callbackactivity = "Myebook";
 //BA.debugLineNum = 38;BA.debugLine="HttpUtils.CallbackJobDoneSub = \"JobDone\"    '設定當HTTP完成下載工作之後，所要觸發的事件名稱";
...
public static String  _btnlogin_click() throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub btnLogin_Click  '檢查會員身份";
 //BA.debugLineNum = 51;BA.debugLine="If edtPassword.Text=\"\" Then  '檢查是否有輸入密碼";
if ((mostCurrent._edtpassword.getText()).equals("")) { 
 //BA.debugLineNum = 52;BA.debugLine="Msgbox(\"您尚未填入密碼\",\"錯誤訊息\")";
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未填入密碼","錯誤訊息",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 54;BA.debugLine="Password = edtPassword.Text '將輸入的密碼指定給Password變數";
_password = mostCurrent._edtpassword.getText();
 //BA.debugLineNum = 55;BA.debugLine="StartActivity(Member)      '啟動Myebook活動頁面";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._member.getObject()));
 };
...
myebook._process_globals();
 ...
 //BA.debugLineNum = 28;BA.debugLine="Dim Label1 As Label            'B4A讀取SQL Server資料(檢查會員身份)";
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Dim edtPassword As EditText    '輸入密碼";
mostCurrent._edtpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Dim btnLogin As Button         '檢查會員身份";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Dim Password As String        '會員密碼";
_password = "";
 //BA.debugLineNum = 17;BA.debugLine="Dim DNS1,DNS2 As String          '宣告兩個領域名稱";
_dns1 = "";
_dns2 = "";
 //BA.debugLineNum = 18;BA.debugLine="Dim ServerUrl As String       '宣告Web Service的網址";
_serverurl = "";
 //BA.debugLineNum = 21;BA.debugLine="DNS1 = \"http://120.118.165.192/B4A/B4AToSQL.aspx?query=select * from Member\"";
_dns1 = "http://120.118.165.192/B4A/B4AToSQL.aspx?query=select * from Member";
 //BA.debugLineNum = 22;BA.debugLine="DNS2 = \"http://120.118.165.192/B4A/B4AToSQL.aspx?query=select * from Myebook\"";
_dns2 = "http://120.118.165.192/B4A/B4AToSQL.aspx?query=select * from Myebook";
 //BA.debugLineNum = 24;BA.debugLine="ServerUrl = \"http://120.118.165.192/B4A/B4AToSQL.aspx\"";
