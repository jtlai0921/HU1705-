...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"Myebook\")                         '使用「Main(版面配置檔)」來輸出";
mostCurrent._activity.LoadLayout("Myebook",mostCurrent.activityBA);
 //BA.debugLineNum = 26;BA.debugLine="Activity.Title =\"歡迎閱讀電子書\"    '本頁的標題名稱";
mostCurrent._activity.setTitle((Object)("歡迎閱讀電子書"));
 //BA.debugLineNum = 27;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 28;BA.debugLine="HttpUtils.CallbackActivity = \"Myebook\"      '設定回覆的活動頁面名稱";
mostCurrent._httputils._callbackactivity = "Myebook";
 //BA.debugLineNum = 29;BA.debugLine="HttpUtils.CallbackJobDoneSub = \"JobDone\"    '設定當HTTP完成下載工作之後，所要觸發的事件名稱";
mostCurrent._httputils._callbackjobdonesub = "JobDone";
 };
 //BA.debugLineNum = 31;BA.debugLine="StrSQL=\"select * from Myebook\"";
_strsql = "select * from Myebook";
 //BA.debugLineNum = 33;BA.debugLine="lblResult.Text=\"電子書載入中...\"";
mostCurrent._lblresult.setText((Object)("電子書載入中..."));
 //BA.debugLineNum = 34;BA.debugLine="lblShowebook.Visible=False";
mostCurrent._lblshowebook.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 35;BA.debugLine="HttpUtils.PostString(\"MyJob2\", ServerUrl, StrSQL)";
mostCurrent._httputils._poststring(mostCurrent.activityBA,"MyJob2",_serverurl,_strsql);
 //BA.debugLineNum = 36;BA.debugLine="Listebook  '顯示書單";
_listebook();
...
public static String  _btnreturn_click() throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub btnReturn_Click";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Dim btnReturn As Button    '返回鈕";
mostCurrent._btnreturn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Dim lblResult As Label     '顯示「會員身份審查結果」標題字";
mostCurrent._lblresult = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Dim lblShowebook As Label  '顯示「請點選喜歡的電子書」標題字";
mostCurrent._lblshowebook = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim livebook As ListView   '用來顯示電子書的清單內容";
...
public static String  _jobdone(String _job) throws Exception{
 //BA.debugLineNum = 39;BA.debugLine="Sub JobDone (Job As String)";
 //BA.debugLineNum = 40;BA.debugLine="If HttpUtils.IsSuccess(Main.ServerUrl) Then        '當HTTP完成下載成功";
if (mostCurrent._httputils._issuccess(mostCurrent.activityBA,mostCurrent._main._serverurl)) { 
 //BA.debugLineNum = 41;BA.debugLine="ToastMessageShow(\"連線成功!!\", True)  '顯示資料載入完成!!";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("連線成功!!",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 42;BA.debugLine="response = HttpUtils.GetString(ServerUrl) '取得Web Service的回覆";
_response = mostCurrent._httputils._getstring(mostCurrent.activityBA,_serverurl);
 //BA.debugLineNum = 43;BA.debugLine="JSON.Initialize(response)                 '用來剖析「Web Service的回覆」資料格式內容";
_json.Initialize(_response);
 }else {
 //BA.debugLineNum = 45;BA.debugLine="ToastMessageShow(\"連線失敗!!\", True)      '顯示載入失敗!!";
...
int _i = 0;
 //BA.debugLineNum = 49;BA.debugLine="Sub Listebook()";
 //BA.debugLineNum = 50;BA.debugLine="livebook.SingleLineLayout.Label.TextSize=20";
mostCurrent._livebook.getSingleLineLayout().Label.setTextSize((float) (20));
 //BA.debugLineNum = 51;BA.debugLine="livebook.SingleLineLayout.ItemHeight = 25dip";
mostCurrent._livebook.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 52;BA.debugLine="Dim ArrayRows As List            'ArrayRows視為陣列";
_arrayrows = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 53;BA.debugLine="Dim Key_Value As Map             'Key_Value視為成對的(key和Value)";
_key_value = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 54;BA.debugLine="ArrayRows = JSON.NextArray()     '將取得的JSON資料剖析成List串列(亦即資料列)";
_arrayrows = _json.NextArray();
 //BA.debugLineNum = 55;BA.debugLine="For i = 0 To ArrayRows.Size - 1  '顯示全部的記錄（資料列）";
{
final int step41 = 1;
final int limit41 = (int) (_arrayrows.getSize()-1);
for (_i = (int) (0); (step41 > 0 && _i <= limit41) || (step41 < 0 && _i >= limit41); _i = ((int)(0 + _i + step41))) {
 //BA.debugLineNum = 56;BA.debugLine="Key_Value = ArrayRows.Get(i) '取得每一筆記錄";
_key_value.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_arrayrows.Get(_i)));
 //BA.debugLineNum = 57;BA.debugLine="livebook.AddSingleLine((i+1) & \". 書名：\" & Key_Value.Get(\"Book_Name\")) '顯示記錄的中的「Book_Name」欄位值";
mostCurrent._livebook.AddSingleLine(BA.NumberToString((_i+1))+". 書名："+BA.ObjectToString(_key_value.Get((Object)("Book_Name"))));
 }
};
 //BA.debugLineNum = 59;BA.debugLine="lblShowebook.Visible=True";
mostCurrent._lblshowebook.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 60;BA.debugLine="lblResult.Text=\"電子書載入完成！！\"";
...
String _temp = "";
 //BA.debugLineNum = 63;BA.debugLine="Sub livebook_ItemClick (Position As Int, Value As Object)";
 //BA.debugLineNum = 64;BA.debugLine="Dim Temp As String";
_temp = "";
 //BA.debugLineNum = 65;BA.debugLine="Temp = \"你剛才點選的電子書為：\" & CRLF";
_temp = "你剛才點選的電子書為："+anywheresoftware.b4a.keywords.Common.CRLF;
 //BA.debugLineNum = 66;BA.debugLine="Temp = Temp & livebook.GetItem(Position)";
_temp = _temp+BA.ObjectToString(mostCurrent._livebook.GetItem(_position));
 //BA.debugLineNum = 67;BA.debugLine="lblShowebook.Text =Temp";
...
_strsql = "";
 //BA.debugLineNum = 13;BA.debugLine="Dim ServerUrl As String       '宣告Web Service的網址";
_serverurl = "";
 //BA.debugLineNum = 14;BA.debugLine="ServerUrl = \"http://120.118.165.192/B4A/B4AToSQL.aspx\"";
