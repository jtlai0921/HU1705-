...
public anywheresoftware.b4a.objects.ButtonWrapper _btnloadmysqldb = null;
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="Activity.Title =\"B4A讀取MySQL資料\"     '本頁面的標題名稱";
mostCurrent._activity.setTitle((Object)("B4A讀取MySQL資料"));
...
public static String  _btnloadmysqldb_click() throws Exception{
...
int _i = 0;
 //BA.debugLineNum = 54;BA.debugLine="Sub btnLoadMySQLDB_Click         'B4A讀取SQL Server資料";
...
myebook._process_globals();
 ...
 //BA.debugLineNum = 23;BA.debugLine="Dim btnLoadMySQLDB As Button  '讀取遠端DB";
mostCurrent._btnloadmysqldb = new anywheresoftware.b4a.objects.ButtonWrapper();
...
_strsql = "";
 //BA.debugLineNum = 16;BA.debugLine="DNS = \"http://120.118.165.192:81/B4ASQL/b4asql.php?sqlre=Select * from Myebook\"";
_dns = "http://120.118.165.192:81/B4ASQL/b4asql.php?sqlre=Select * from Myebook";
 //BA.debugLineNum = 18;BA.debugLine="ServerUrl = \"http://120.118.165.192:81/B4ASQL/b4asql.php\"";
