...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 21;BA.debugLine="Activity.LoadLayout(\"Myebook\")";
mostCurrent._activity.LoadLayout("Myebook",mostCurrent.activityBA);
 //BA.debugLineNum = 22;BA.debugLine="Activity.Title =\"瀏覽網站SQL Server資料庫\"";
mostCurrent._activity.setTitle((Object)("瀏覽網站SQL Server資料庫"));
...
String _dns = "";
 ...
 //BA.debugLineNum = 26;BA.debugLine="Dim DNS As String=Main.DNS   '領域名稱";
_dns = mostCurrent._main._dns;
 //BA.debugLineNum = 27;BA.debugLine="WebView1.LoadUrl(DNS)'WebView物件利用LoadUrl方法來連接";
mostCurrent._webview1.LoadUrl(_dns);
 //BA.debugLineNum = 28;BA.debugLine="End Sub";
return "";
}
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 35;BA.debugLine="Activity.Finish()    '活動完成";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 36;BA.debugLine="StartActivity(Main)  ' 返回Main主活動";
