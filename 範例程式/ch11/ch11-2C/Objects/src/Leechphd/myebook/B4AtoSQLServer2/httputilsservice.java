...
public class httputilsservice extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "Leechphd.myebook.B4AtoSQLServer2", "Leechphd.myebook.B4AtoSQLServer2.httputilsservice");
            try {
        ...
        if (BA.shellMode) {
			processBA.raiseEvent2(null, true, "CREATE", true, "Leechphd.myebook.B4AtoSQLServer2.httputilsservice", processBA, _service);
		}
