...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 49;BA.debugLine="Activity.Title =\"B4A連結SQL_Server(手動更新SQLite)\"    '本頁的標題名稱";
mostCurrent._activity.setTitle((Object)("B4A連結SQL_Server(手動更新SQLite)"));
...
_dns2 = "http://120.118.165.192/B4A/B4AToSQL.aspx?query=select * from Myebook";
 //BA.debugLineNum = 23;BA.debugLine="ServerUrl = \"http://120.118.165.192/B4A/B4AToSQL.aspx\"";
