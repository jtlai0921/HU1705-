...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "tw.idv.myebook.project10", "tw.idv.myebook.project10.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "tw.idv.myebook.project10", "tw.idv.myebook.project10.main");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "tw.idv.myebook.project10.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 33;BA.debugLine="If File.Exists(File.DirDefaultExternal, \"MyeSchoolDB.sqlite\") = False Then  '判斷「SD卡」是否存在資料庫檔案，如果沒有，則";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"MyeSchoolDB.sqlite")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 34;BA.debugLine="File.Copy(File.DirAssets, \"MyeSchoolDB.sqlite\",File.DirDefaultExternal, \"MyeSchoolDB.sqlite\")  '從Files頁籤中的資料庫檔案複製到「SD卡」中";
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 37;BA.debugLine="Activity.Title =\"行動選課系統App\"";
mostCurrent._activity.setTitle((Object)("行動選課系統App"));
 //BA.debugLineNum = 38;BA.debugLine="TabHost1.AddTab(\"科系管理\",\"Department_home\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"科系管理","Department_home");
 //BA.debugLineNum = 39;BA.debugLine="TabHost1.AddTab(\"課程管理\",\"Course_home\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"課程管理","Course_home");
 //BA.debugLineNum = 40;BA.debugLine="TabHost1.AddTab(\"學生管理\",\"Student_home\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"學生管理","Student_home");
 //BA.debugLineNum = 41;BA.debugLine="TabHost1.AddTab(\"選課作業\",\"Course_Selection_home\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"選課作業","Course_Selection_home");
 //BA.debugLineNum = 42;BA.debugLine="TabHost1.AddTab(\"查詢作業\",\"Query_home\")";
...
public static String  _btncallcourse_click() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub btnCallCourse_Click";
 //BA.debugLineNum = 49;BA.debugLine="StartActivity(Course)             '課程管理";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._v0.getObject()));
 //BA.debugLineNum = 50;BA.debugLine="End Sub";
return "";
}
public static String  _btncallcourse_selection_click() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub btnCallCourse_Selection_Click";
 //BA.debugLineNum = 55;BA.debugLine="StartActivity(Course_Selection)   '選課作業";
...
public static String  _btncalldepartment_click() throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub btnCallDepartment_Click";
 //BA.debugLineNum = 46;BA.debugLine="StartActivity(Department)         '科系管理";
...
public static String  _btncallquery_click() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub btnCallQuery_Click";
 //BA.debugLineNum = 58;BA.debugLine="StartActivity(Query)              '查詢作業";
...
public static String  _btncallstudent_click() throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub btnCallStudent_Click";
 //BA.debugLineNum = 52;BA.debugLine="StartActivity(Student)            '學生管理";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._vv3.getObject()));
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return "";
}
public static String  _btnexitapp_click() throws Exception{
String _msg_value = "";
 //BA.debugLineNum = 61;BA.debugLine="Sub btnExitApp_Click";
 //BA.debugLineNum = 62;BA.debugLine="Dim Msg_Value As String";
_msg_value = "";
 //BA.debugLineNum = 63;BA.debugLine="Msg_Value = Msgbox2(\"您確定要結束本系統嗎?\", \"行動選課系統APP\", \"確認\", \"\", \"取消\", LoadBitmap(File.DirAssets,\"Leech_icon.jpg\"))";
_msg_value = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Msgbox2("您確定要結束本系統嗎?","行動選課系統APP","確認","","取消",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Leech_icon.jpg").getObject()),mostCurrent.activityBA));
 //BA.debugLineNum = 64;BA.debugLine="If Msg_Value = DialogResponse.POSITIVE Then'";
if ((_msg_value).equals(BA.NumberToString(anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE))) { 
 //BA.debugLineNum = 65;BA.debugLine="Activity.Finish()  '活動完成";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 66;BA.debugLine="ExitApplication    '離開";
