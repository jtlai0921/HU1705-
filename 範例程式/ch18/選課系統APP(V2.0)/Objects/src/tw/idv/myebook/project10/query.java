...
public class query extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "tw.idv.myebook.project10", "tw.idv.myebook.project10.query");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "tw.idv.myebook.project10", "tw.idv.myebook.project10.query");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "tw.idv.myebook.project10.query", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
if (mostCurrent._vv4._v7.length()>0) { 
...
mostCurrent._edtsql.setText((Object)(mostCurrent._vv4._v7));
 };
...
_vv5(mostCurrent._edtsql.getText());
 };
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._vv4.getObject()));
...
{
final int step81 = 1;
final int limit81 = (int) (_v6.getColumnCount()-1);
...
{
final int step89 = 1;
final int limit89 = (int) (_v6.getColumnCount()-1);
for (_vvv5 = (int) (0); (step89 > 0 && _vvv5 <= limit89) || (step89 < 0 && _vvv5 >= limit89); _vvv5 = ((int)(0 + _vvv5 + step89))) {
...
mostCurrent._vvv1 = mostCurrent._vvv1+_v6.GetString(_v6.GetColumnName(_vvv5))+"    ";
 }
};
 //BA.debugLineNum = 105;BA.debugLine="livSQLView.AddSingleLine ((i+1) & \". \" & strSqlViewContent )   '顯示「每一筆記錄的內容」";
mostCurrent._livsqlview.AddSingleLine(BA.NumberToString((_i+1))+". "+mostCurrent._vvv1);
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow("符合條件的記錄共有: "+BA.NumberToString(_v6.getRowCount())+" 筆!",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 109;BA.debugLine="lblResult.Text =\"==符合條件的記錄共有( \" & CursorDBPoint.RowCount & \" 筆)==\"";
mostCurrent._lblresult.setText((Object)("==符合條件的記錄共有( "+BA.NumberToString(_v6.getRowCount())+" 筆)=="));
