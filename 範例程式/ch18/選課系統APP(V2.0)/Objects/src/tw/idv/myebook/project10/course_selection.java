...
public class course_selection extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "tw.idv.myebook.project10", "tw.idv.myebook.project10.course_selection");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "tw.idv.myebook.project10", "tw.idv.myebook.project10.course_selection");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "tw.idv.myebook.project10.course_selection", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
{
final int step41 = 1;
final int limit41 = (int) (_v6.getRowCount()-1);
...
mostCurrent._spnaddcourse.Add(_v6.GetString("課號")+"/"+_v6.GetString("課名")+"("+_v6.GetString("學分數")+")");
 }
};
...
{
final int step30 = 1;
final int limit30 = (int) (_v6.getRowCount()-1);
...
mostCurrent._spnstudent.Add(_v6.GetString("學號")+"/"+_v6.GetString("姓名"));
 }
};
...
_strsql = "DELETE FROM 選課資料表 Where 學號='"+mostCurrent._spnstudent.getSelectedItem().substring((int) (0),(int) (5))+"' And 課號='"+BA.ObjectToString(mostCurrent._livviewaddcourse.GetItem(_position))+"' ";
 //BA.debugLineNum = 114;BA.debugLine="SQLCmd.ExecNonQuery(strSQL)";
_v5.ExecNonQuery(_strsql);
 //BA.debugLineNum = 115;BA.debugLine="livViewAddCourse.RemoveAt(Position)";
mostCurrent._livviewaddcourse.RemoveAt(_position);
 //BA.debugLineNum = 116;BA.debugLine="ToastMessageShow(\"刪除一筆「學生資料」記錄...\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("刪除一筆「學生資料」記錄...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 117;BA.debugLine="QueryDBList(strViewAddCourse)      '顯示您已加選的課程清單";
_vv5(mostCurrent._vvv3);
 };
...
int _i = 0;
int _j = 0;
 //BA.debugLineNum = 121;BA.debugLine="Sub QueryDBList(strSQLite As String)";
 //BA.debugLineNum = 122;BA.debugLine="livViewAddCourse.Clear '清單清空";
mostCurrent._livviewaddcourse.Clear();
 //BA.debugLineNum = 123;BA.debugLine="strSqlViewTitle =\"\"";
mostCurrent._vv7 = "";
 //BA.debugLineNum = 124;BA.debugLine="strSqlViewContent =\"\"";
mostCurrent._vvv1 = "";
 //BA.debugLineNum = 125;BA.debugLine="strLine =\"\"";
mostCurrent._vv0 = "";
 //BA.debugLineNum = 126;BA.debugLine="CursorDBPoint = SQLCmd.ExecQuery(strSQLite)";
_v6.setObject((android.database.Cursor)(_v5.ExecQuery(_strsqlite)));
 //BA.debugLineNum = 127;BA.debugLine="livViewAddCourse.SingleLineLayout.Label.TextSize=16";
mostCurrent._livviewaddcourse.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 128;BA.debugLine="livViewAddCourse.SingleLineLayout.ItemHeight = 20dip";
mostCurrent._livviewaddcourse.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 129;BA.debugLine="For i = 0 To CursorDBPoint.ColumnCount-1    '取得「欄位名稱」";
{
final int step108 = 1;
final int limit108 = (int) (_v6.getColumnCount()-1);
for (_i = (int) (0); (step108 > 0 && _i <= limit108) || (step108 < 0 && _i >= limit108); _i = ((int)(0 + _i + step108))) {
 //BA.debugLineNum = 130;BA.debugLine="strSqlViewTitle=strSqlViewTitle & CursorDBPoint.GetColumnName(i) & \"         \"";
mostCurrent._vv7 = mostCurrent._vv7+_v6.GetColumnName(_i)+"         ";
 //BA.debugLineNum = 131;BA.debugLine="strLine=strLine & \"=======\"              '設定「分隔水平線之每一小段的長度」";
mostCurrent._vv0 = mostCurrent._vv0+"=======";
 }
};
 //BA.debugLineNum = 133;BA.debugLine="livViewAddCourse.AddSingleLine (strSqlViewTitle)  '顯示「欄位名稱」";
mostCurrent._livviewaddcourse.AddSingleLine(mostCurrent._vv7);
 //BA.debugLineNum = 134;BA.debugLine="livViewAddCourse.AddSingleLine (strLine)          '顯示「分隔水平線」";
mostCurrent._livviewaddcourse.AddSingleLine(mostCurrent._vv0);
 //BA.debugLineNum = 135;BA.debugLine="For i = 0 To CursorDBPoint.RowCount - 1     '控制「記錄」的筆數";
{
final int step114 = 1;
final int limit114 = (int) (_v6.getRowCount()-1);
for (_i = (int) (0); (step114 > 0 && _i <= limit114) || (step114 < 0 && _i >= limit114); _i = ((int)(0 + _i + step114))) {
 //BA.debugLineNum = 136;BA.debugLine="CursorDBPoint.Position = i              '記錄指標從第1筆開始(索引為0)";
_v6.setPosition(_i);
 //BA.debugLineNum = 137;BA.debugLine="For j=0 To CursorDBPoint.ColumnCount-1    '控制「欄位」的個數";
{
final int step116 = 1;
final int limit116 = (int) (_v6.getColumnCount()-1);
for (_j = (int) (0); (step116 > 0 && _j <= limit116) || (step116 < 0 && _j >= limit116); _j = ((int)(0 + _j + step116))) {
 //BA.debugLineNum = 138;BA.debugLine="strSqlViewContent=strSqlViewContent & CursorDBPoint.GetString(CursorDBPoint.GetColumnName(j)) & \"    \"";
...
mostCurrent._livviewaddcourse.AddSingleLine2(BA.NumberToString((_i+1))+". "+mostCurrent._vvv1,(Object)(_v6.GetString(_v6.GetColumnName((int) (2)))));
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow("目前您的加選科目，共有: "+BA.NumberToString(_v6.getRowCount())+" 筆!",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 145;BA.debugLine="lblResult.Text =\"===您已加選課程清單( \" & CursorDBPoint.RowCount & \" 筆)===\"";
mostCurrent._lblresult.setText((Object)("===您已加選課程清單( "+BA.NumberToString(_v6.getRowCount())+" 筆)==="));
...
mostCurrent._vvv3 = "Select A.學號,姓名,B.課號,課名,學分數 FROM 學生資料表 As A,課程資料表 As B,選課資料表 As C"+" Where A.學號=C.學號 And B.課號=C.課號 And C.學號='"+mostCurrent._spnstudent.getSelectedItem().substring((int) (0),(int) (5))+"'";
