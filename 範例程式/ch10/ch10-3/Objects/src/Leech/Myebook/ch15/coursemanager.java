...
public class coursemanager extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "Leech.Myebook.ch15", "Leech.Myebook.ch15.coursemanager");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Leech.Myebook.ch15", "Leech.Myebook.ch15.coursemanager");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Leech.Myebook.ch15.coursemanager", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
public Leech.Myebook.ch15.main _main = null;
...
mostCurrent._edtcourcredits.setText((Object)("3"));
 //BA.debugLineNum = 48;BA.debugLine="QueryDBList(\"Select * FROM 課程資料表\")                '呼叫顯示「課程資料」全部記錄(多筆清單)";
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow("刪除一筆「課程代號」記錄...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 117;BA.debugLine="QueryDBList(\"Select * FROM 課程資料表\")";
_querydblist("Select * FROM 課程資料表");
 };
...
if ((_courno).equals("") || (_courname).equals("") || (_courcredits).equals("")) { 
 //BA.debugLineNum = 66;BA.debugLine="Msgbox(\"您尚未完整輸入「課程資料」哦！\",\"錯誤訊息回報!!!\")";
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未完整輸入「課程資料」哦！","錯誤訊息回報!!!",mostCurrent.activityBA);
 }else {
...
_strsql = "INSERT INTO 課程資料表(課號,課名,學分數)"+"VALUES('"+_courno+"','"+_courname+"'"+",'"+_courcredits+"')";
 //BA.debugLineNum = 71;BA.debugLine="Check_CourID_Exists(CourNo)        '呼叫檢查「課程資料」是否有重複新增之副程式";
...
if (_check_courid_exist==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 73;BA.debugLine="Msgbox(\"您已經重複新增「課程資料」了！\",\"新增錯誤訊息!!!\")";
anywheresoftware.b4a.keywords.Common.Msgbox("您已經重複新增「課程資料」了！","新增錯誤訊息!!!",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 75;BA.debugLine="SQLCmd.ExecNonQuery(strSQL)                             '執行SQL指令，以成功的新增記錄";
_sqlcmd.ExecNonQuery(_strsql);
 //BA.debugLineNum = 76;BA.debugLine="ToastMessageShow(\"您新增成功「課程資料」記錄!\", True)   '顯示新增成功狀態";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("您新增成功「課程資料」記錄!",anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 78;BA.debugLine="Check_CourID_Exist=False           '設定沒有重複新增「課程資料」";
_check_courid_exist = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 80;BA.debugLine="QueryDBList(\"Select * FROM 課程資料表\")";
_querydblist("Select * FROM 課程資料表");
...
public static String  _btnlistdata_click() throws Exception{
 ...
 //BA.debugLineNum = 178;BA.debugLine="QueryDBList(\"Select * FROM 課程資料表\")";
_querydblist("Select * FROM 課程資料表");
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow("更新一筆「課程代號」記錄...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 104;BA.debugLine="QueryDBList(\"Select * FROM 課程資料表\")";
_querydblist("Select * FROM 課程資料表");
 };
...
String _sql_query = "";
 //BA.debugLineNum = 83;BA.debugLine="Sub Check_CourID_Exists(strCourNo As String)  '檢查「課程資料」是否有重複新增之副程式";
...
if (_cursordbpoint.getRowCount()>0) { 
 //BA.debugLineNum = 88;BA.debugLine="Check_CourID_Exist=True        '代表重複新增「課程資料」了!";
...
int _i = 0;
int _j = 0;
 //BA.debugLineNum = 150;BA.debugLine="Sub QueryDBList(strSQLite As String)";
...
_cursordbpoint.setObject((android.database.Cursor)(_sqlcmd.ExecQuery(_strsqlite)));
 //BA.debugLineNum = 156;BA.debugLine="livCourse.SingleLineLayout.Label.TextSize=14";
mostCurrent._livcourse.getSingleLineLayout().Label.setTextSize((float) (14));
 //BA.debugLineNum = 157;BA.debugLine="livCourse.SingleLineLayout.ItemHeight = 16dip";
