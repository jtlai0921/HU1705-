...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "Leech.myebook.ch06.example", "Leech.myebook.ch06.example.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Leech.myebook.ch06.example", "Leech.myebook.ch06.example.main");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Leech.myebook.ch06.example.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"後測試迴圈(使用Exit關鍵字)\"";
mostCurrent._activity.setTitle((Object)("後測試迴圈(使用Exit關鍵字)"));
...
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入數值資料哦!","產生錯誤...",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 44;BA.debugLine="Dim Number,i,Sum As Int";
_number = 0;
_i = 0;
_sum = 0;
...
_number = (int)(Double.parseDouble(mostCurrent._edtnumber.getText()));
 //BA.debugLineNum = 47;BA.debugLine="Do While Number>=1";
while (_number>=1) {
 //BA.debugLineNum = 48;BA.debugLine="Sum = Sum + i";
_sum = (int) (_sum+_i);
 //BA.debugLineNum = 49;BA.debugLine="If i>=1 Then Temp=Temp & i & \"+\"";
if (_i>=1) { 
_temp = _temp+BA.NumberToString(_i)+"+";};
 //BA.debugLineNum = 50;BA.debugLine="i = i + 1";
_i = (int) (_i+1);
 //BA.debugLineNum = 51;BA.debugLine="If i>10 Then Exit";
if (_i>10) { 
if (true) break;};
 }
;
 //BA.debugLineNum = 53;BA.debugLine="lblResult.Text=Temp.SubString2(0,Temp.Length-1) & \"=\" & Sum";
mostCurrent._lblresult.setText((Object)(_temp.substring((int) (0),(int) (_temp.length()-1))+"="+BA.NumberToString(_sum)));
 };
