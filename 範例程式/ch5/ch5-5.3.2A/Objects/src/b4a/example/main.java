...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"判斷奇數或偶數(Select/Case)\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("判斷奇數或偶數(Select/Case)"));
...
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入數值資料哦!","產生錯誤...",mostCurrent.activityBA);
 ...
 BA.debugLineNum = 44;BA.debugLine="Dim Number,Result As Int";
Debug.ShouldStop(2048);
_number = 0;Debug.locals.put("Number", _number);
_result = 0;Debug.locals.put("Result", _result);
 BA.debugLineNum = 45;BA.debugLine="Number =edtNumber.Text";
Debug.ShouldStop(4096);
_number = (int)(Double.parseDouble(mostCurrent._edtnumber.getText()));Debug.locals.put("Number", _number);
 BA.debugLineNum = 46;BA.debugLine="Result=Number Mod 2";
Debug.ShouldStop(8192);
_result = (int) (_number%2);Debug.locals.put("Result", _result);
 BA.debugLineNum = 47;BA.debugLine="Select Result";
Debug.ShouldStop(16384);
switch (_result) {
case 0:
 BA.debugLineNum = 49;BA.debugLine="lblResult.Text=\"偶數!\"";
Debug.ShouldStop(65536);
mostCurrent._lblresult.setText((Object)("偶數!"));
 break;
case 1:
 BA.debugLineNum = 51;BA.debugLine="lblResult.Text=\"奇數!\"";
Debug.ShouldStop(262144);
mostCurrent._lblresult.setText((Object)("奇數!"));
 break;
}
;
 };
...
Debug.StartDebugging(mostCurrent.activityBA, 5608, new int[] {2}, "aaf7cc47-3c72-42b7-b30e-7b0668e0cc47");}
