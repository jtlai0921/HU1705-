...
public static RemoteObject _btnrun = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _edtnumber = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"btnRun",main.mostCurrent._btnrun,"edtNumber",main.mostCurrent._edtnumber,"lblResult",main.mostCurrent._lblresult};
}
}