...
public anywheresoftware.b4a.objects.EditTextWrapper _edtc = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"btnRun",mostCurrent._btnrun,"edtC",mostCurrent._edtc,"lblResult",mostCurrent._lblresult};
}
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"「攝氏轉換華氏」功能的程式APP\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("「攝氏轉換華氏」功能的程式APP"));
...
Debug.ShouldStop(128);
 BA.debugLineNum = 41;BA.debugLine="Dim C As Int";
Debug.ShouldStop(256);
_c = 0;Debug.locals.put("C", _c);
 BA.debugLineNum = 42;BA.debugLine="Dim F As Float";
Debug.ShouldStop(512);
_f = 0f;Debug.locals.put("F", _f);
 BA.debugLineNum = 43;BA.debugLine="C=edtC.Text             '攝氏C";
Debug.ShouldStop(1024);
_c = (int)(Double.parseDouble(mostCurrent._edtc.getText()));Debug.locals.put("C", _c);
 BA.debugLineNum = 44;BA.debugLine="F=C*9/5+32              '計算結果";
Debug.ShouldStop(2048);
_f = (float) (_c*9/(double)5+32);Debug.locals.put("F", _f);
 BA.debugLineNum = 45;BA.debugLine="lblResult.Text =F";
...
Debug.StartDebugging(mostCurrent.activityBA, 15553, new int[] {2}, "b5833be1-3a05-4d4e-b24b-2d48e125a462");}
...
mostCurrent._btnrun = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Dim edtC As EditText";
