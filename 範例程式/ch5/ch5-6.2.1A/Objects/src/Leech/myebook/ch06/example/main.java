...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"前測試迴圈(Do While/Loop)\"";
mostCurrent._activity.setTitle((Object)("前測試迴圈(Do While/Loop)"));
...
_number = (int)(Double.parseDouble(mostCurrent._edtnumber.getText()));
 //BA.debugLineNum = 47;BA.debugLine="Do While i <= Number";
while (_i<=_number) {
