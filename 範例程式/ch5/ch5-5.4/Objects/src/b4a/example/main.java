...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"巢狀IF判斷成績\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("巢狀IF判斷成績"));
...
Debug.ShouldStop(64);
 BA.debugLineNum = 40;BA.debugLine="If edtNumber.Text=\"\"  Then";
...
_score = 0;Debug.locals.put("Score", _score);
 BA.debugLineNum = 44;BA.debugLine="Score =edtNumber.Text";
Debug.ShouldStop(2048);
_score = (int)(Double.parseDouble(mostCurrent._edtnumber.getText()));Debug.locals.put("Score", _score);
 BA.debugLineNum = 45;BA.debugLine="If Score < 60 Then";
Debug.ShouldStop(4096);
if (_score<60) { 
 BA.debugLineNum = 46;BA.debugLine="lblResult.Text = \"不及格\"";
Debug.ShouldStop(8192);
mostCurrent._lblresult.setText((Object)("不及格"));
 }else {
 BA.debugLineNum = 48;BA.debugLine="If Score >= 60 AND Score <= 89 Then";
Debug.ShouldStop(32768);
if (_score>=60 && _score<=89) { 
 BA.debugLineNum = 49;BA.debugLine="lblResult.Text = \"及格\"";
Debug.ShouldStop(65536);
mostCurrent._lblresult.setText((Object)("及格"));
 }else {
 BA.debugLineNum = 51;BA.debugLine="lblResult.Text = \"優等生\"";
Debug.ShouldStop(262144);
mostCurrent._lblresult.setText((Object)("優等生"));
 };
 };
 };
...
Debug.StartDebugging(mostCurrent.activityBA, 23894, new int[] {2}, "a772706a-8fd6-412d-874c-ed9e1fc508f0");}
