...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="Activity.Title=\"判斷奇數或偶數\"";
Debug.ShouldStop(268435456);
mostCurrent._activity.setTitle((Object)("判斷奇數或偶數"));
...
if (_number%2==0) { 
 BA.debugLineNum = 47;BA.debugLine="lblResult.Text=\"偶數!\"";
Debug.ShouldStop(16384);
mostCurrent._lblresult.setText((Object)("偶數!"));
 BA.debugLineNum = 48;BA.debugLine="Msgbox(\"偶數!\",\"判斷結果\")";
Debug.ShouldStop(32768);
anywheresoftware.b4a.keywords.Common.Msgbox("偶數!","判斷結果",mostCurrent.activityBA);
 }else {
 BA.debugLineNum = 50;BA.debugLine="lblResult.Text=\"奇數!\"";
Debug.ShouldStop(131072);
mostCurrent._lblresult.setText((Object)("奇數!"));
 BA.debugLineNum = 51;BA.debugLine="Msgbox(\"奇數!\",\"判斷結果\")";
Debug.ShouldStop(262144);
anywheresoftware.b4a.keywords.Common.Msgbox("奇數!","判斷結果",mostCurrent.activityBA);
 };
 };
...
Debug.StartDebugging(mostCurrent.activityBA, 13038, new int[] {2}, "3bb83dd1-bd5a-423c-9137-8dd42fd0781d");}
