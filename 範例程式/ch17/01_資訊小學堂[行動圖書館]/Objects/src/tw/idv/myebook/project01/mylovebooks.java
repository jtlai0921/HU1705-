...
public class mylovebooks extends Activity implements B4AActivity{
	public static mylovebooks mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "tw.idv.myebook.project01", "tw.idv.myebook.project01.mylovebooks");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mylovebooks).");
				p.finish();
			}
		}
		if (!includeTitle) {
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "tw.idv.myebook.project01", "tw.idv.myebook.project01.mylovebooks");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "tw.idv.myebook.project01.mylovebooks", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mylovebooks) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mylovebooks) Resume **");
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (mylovebooks) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String _bookid_4 = "";
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 19;BA.debugLine="If SQLCmd.IsInitialized() = False Then";
if (_sqlcmd.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 20;BA.debugLine="SQLCmd.Initialize(File.DirDefaultExternal, \"MyebookDBS.sqlite\", False)";
_sqlcmd.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"MyebookDBS.sqlite",anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"MyloveBooks\")";
mostCurrent._activity.LoadLayout("MyloveBooks",mostCurrent.activityBA);
 //BA.debugLineNum = 23;BA.debugLine="Activity.Title =\"我的最愛書籍\"";
mostCurrent._activity.setTitle((Object)("我的最愛書籍"));
...
String _account = "";
 ...
 //BA.debugLineNum = 28;BA.debugLine="Dim Account As String =UserLogin.UserAccount";
_account = mostCurrent._userlogin._useraccount;
 //BA.debugLineNum = 29;BA.debugLine="SQL_Query=\"Select 出版社名稱,B.書號,書名 FROM 出版社資料表 As A ,書籍資料表 As B,借閱記錄表 As C Where A.出版社編號=B.出版社編號 AND B.書號=C.書號 And 帳號='\" & Account  & \"'\"";
_sql_query = "Select 出版社名稱,B.書號,書名 FROM 出版社資料表 As A ,書籍資料表 As B,借閱記錄表 As C Where A.出版社編號=B.出版社編號 AND B.書號=C.書號 And 帳號='"+_account+"'";
 //BA.debugLineNum = 30;BA.debugLine="QueryBookTable(SQL_Query)";
_querybooktable(_sql_query);
 //BA.debugLineNum = 31;BA.debugLine="End Sub";
return "";
}
public static String  _btnreturn_click() throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub btnReturn_Click";
 //BA.debugLineNum = 52;BA.debugLine="Activity.Finish()         '活動完成";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 53;BA.debugLine="StartActivity(UserAPP)  ' 返回UserAPP主活動";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 14;BA.debugLine="Dim btnReturn As Button";
mostCurrent._btnreturn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Dim livBookTable As ListView";
...
public static String  _livbooktable_itemclick(int _position,Object _value) throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="BookID_4 = Value    '書籍編號";
_bookid_4 = BA.ObjectToString(_value);
 //BA.debugLineNum = 48;BA.debugLine="StartActivity(\"Myebook\")";
...
_cursordbpoint = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 10;BA.debugLine="Dim BookID_4 As String     '書籍編號";
_bookid_4 = "";
