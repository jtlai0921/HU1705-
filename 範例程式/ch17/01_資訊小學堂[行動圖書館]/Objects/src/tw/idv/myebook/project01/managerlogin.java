...
public class managerlogin extends Activity implements B4AActivity{
	public static managerlogin mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "tw.idv.myebook.project01", "tw.idv.myebook.project01.managerlogin");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (managerlogin).");
				p.finish();
			}
		}
		if (!includeTitle) {
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "tw.idv.myebook.project01", "tw.idv.myebook.project01.managerlogin");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "tw.idv.myebook.project01.managerlogin", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (managerlogin) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (managerlogin) Resume **");
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (managerlogin) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"ManagerLogin\")";
mostCurrent._activity.LoadLayout("ManagerLogin",mostCurrent.activityBA);
 //BA.debugLineNum = 21;BA.debugLine="Activity.Title=\"管理者登入介面\"";
mostCurrent._activity.setTitle((Object)("管理者登入介面"));
 //BA.debugLineNum = 22;BA.debugLine="edtUserAccount.Text=\"12345\"";
mostCurrent._edtuseraccount.setText((Object)("12345"));
 //BA.debugLineNum = 23;BA.debugLine="edtPassword.Text=\"00000\"";
mostCurrent._edtpassword.setText((Object)("00000"));
...
String _useraccount = "";
String _password = "";
 //BA.debugLineNum = 34;BA.debugLine="Sub btnLogin_Click";
 //BA.debugLineNum = 35;BA.debugLine="Dim UserAccount As String";
_useraccount = "";
 //BA.debugLineNum = 36;BA.debugLine="Dim Password As String";
_password = "";
 //BA.debugLineNum = 37;BA.debugLine="UserAccount = edtUserAccount.text";
_useraccount = mostCurrent._edtuseraccount.getText();
 //BA.debugLineNum = 38;BA.debugLine="Password = edtPassword.Text";
_password = mostCurrent._edtpassword.getText();
 //BA.debugLineNum = 39;BA.debugLine="If UserAccount = \"12345\" AND Password = \"00000\" Then";
if ((_useraccount).equals("12345") && (_password).equals("00000")) { 
 //BA.debugLineNum = 40;BA.debugLine="Msgbox(\"您是合法管理者！\",\"系統回覆\")";
anywheresoftware.b4a.keywords.Common.Msgbox("您是合法管理者！","系統回覆",mostCurrent.activityBA);
 //BA.debugLineNum = 41;BA.debugLine="StartActivity(ManagerAPP)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._managerapp.getObject()));
 }else {
 //BA.debugLineNum = 43;BA.debugLine="Msgbox(\"您輸入的帳號或密碼有誤，請重新輸入！\",\"系統回覆\")";
...
public static String  _btnreturn_click() throws Exception{
 //BA.debugLineNum = 47;BA.debugLine="Sub btnReturn_Click";
 //BA.debugLineNum = 48;BA.debugLine="Activity.Finish()  '活動完成";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 13;BA.debugLine="Dim edtUserAccount As EditText";
mostCurrent._edtuseraccount = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Dim edtPassword As EditText";
mostCurrent._edtpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Dim btnLogin As Button";
mostCurrent._btnlogin = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Dim btnReturn As Button";
