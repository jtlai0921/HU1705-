...
public class course extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "Leech.myebook.ch16.Project", "Leech.myebook.ch16.Project.course");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Leech.myebook.ch16.Project", "Leech.myebook.ch16.Project.course");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Leech.myebook.ch16.Project.course", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
_sqlcmd.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"MyeSchoolDB.sqlite",anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 42;BA.debugLine="Activity.LoadLayout(\"Course\")           '使用「Course(版面配置檔)」來輸出";
mostCurrent._activity.LoadLayout("Course",mostCurrent.activityBA);
 //BA.debugLineNum = 43;BA.debugLine="Activity.Title =\"【課程資料管理系統】\"  '本頁的標題名稱";
...
public static String  _btnexitcourse_click() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub btnExitCourse_Click";
 //BA.debugLineNum = 183;BA.debugLine="Activity.Finish()  '活動完成";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 184;BA.debugLine="StartActivity(Main)";
...
public static String  _btnlistdata_click() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Sub btnListData_Click";
 //BA.debugLineNum = 180;BA.debugLine="QueryDBList(\"Select * FROM 課程資料表\")	'呼叫顯示目前存在的課程資料表之副程式";
_querydblist("Select * FROM 課程資料表");
...
mostCurrent._spinquerycourno.Clear();
 //BA.debugLineNum = 126;BA.debugLine="CursorDBPoint = SQLCmd.ExecQuery(\"SELECT 課號 FROM 課程資料表\")";
_cursordbpoint.setObject((android.database.Cursor)(_sqlcmd.ExecQuery("SELECT 課號 FROM 課程資料表")));
 //BA.debugLineNum = 128;BA.debugLine="For i = 0 To CursorDBPoint.RowCount - 1";
{
final int step95 = 1;
final int limit95 = (int) (_cursordbpoint.getRowCount()-1);
for (_i = (int) (0); (step95 > 0 && _i <= limit95) || (step95 < 0 && _i >= limit95); _i = ((int)(0 + _i + step95))) {
 //BA.debugLineNum = 129;BA.debugLine="CursorDBPoint.Position = i      '設定資料庫記錄指標指向每一筆記錄";
_cursordbpoint.setPosition(_i);
 //BA.debugLineNum = 130;BA.debugLine="SpinQueryCourNo.Add(CursorDBPoint.GetString(\"課號\"))";
...
public static String  _callshow_coursedata(String _strsql) throws Exception{
 //BA.debugLineNum = 144;BA.debugLine="Sub CallShow_CourseData(strSQL As String)  '顯示「課程資料表」之副程式";
...
_cursordbpoint.setPosition((int) (0));
 //BA.debugLineNum = 147;BA.debugLine="edtCourNo.Text = CursorDBPoint.GetString(\"課號\")";
mostCurrent._edtcourno.setText((Object)(_cursordbpoint.GetString("課號")));
 //BA.debugLineNum = 148;BA.debugLine="edtCourName.Text=CursorDBPoint.GetString(\"課名\")";
mostCurrent._edtcourname.setText((Object)(_cursordbpoint.GetString("課名")));
 //BA.debugLineNum = 149;BA.debugLine="edtCourCredits.Text=CursorDBPoint.GetString(\"學分數\")";
...
int _i = 0;
int _j = 0;
 //BA.debugLineNum = 152;BA.debugLine="Sub QueryDBList(strSQLite As String)  '顯示目前存在的課程資料表之副程式";
 //BA.debugLineNum = 153;BA.debugLine="livCourse.Clear '清單清空";
...
_cursordbpoint.setObject((android.database.Cursor)(_sqlcmd.ExecQuery(_strsqlite)));
 //BA.debugLineNum = 158;BA.debugLine="livCourse.SingleLineLayout.Label.TextSize=16";
mostCurrent._livcourse.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 159;BA.debugLine="livCourse.SingleLineLayout.ItemHeight = 20dip";
...
{
final int step123 = 1;
final int limit123 = (int) (_cursordbpoint.getColumnCount()-1);
for (_i = (int) (0); (step123 > 0 && _i <= limit123) || (step123 < 0 && _i >= limit123); _i = ((int)(0 + _i + step123))) {
 //BA.debugLineNum = 161;BA.debugLine="strSqlViewTitle=strSqlViewTitle & _ 		CursorDBPoint.GetColumnName(i) & \"          \"";
mostCurrent._strsqlviewtitle = mostCurrent._strsqlviewtitle+_cursordbpoint.GetColumnName(_i)+"          ";
 //BA.debugLineNum = 163;BA.debugLine="strLine=strLine & \"=======\"              '設定「分隔水平線之每一小段的長度」";
mostCurrent._strline = mostCurrent._strline+"=======";
 }
};
 //BA.debugLineNum = 165;BA.debugLine="livCourse.AddSingleLine (strSqlViewTitle)   '顯示「欄位名稱」";
mostCurrent._livcourse.AddSingleLine(mostCurrent._strsqlviewtitle);
 //BA.debugLineNum = 166;BA.debugLine="livCourse.AddSingleLine (strLine)           '顯示「分隔水平線」";
mostCurrent._livcourse.AddSingleLine(mostCurrent._strline);
 //BA.debugLineNum = 167;BA.debugLine="For i = 0 To CursorDBPoint.RowCount - 1     '控制「記錄」的筆數";
{
final int step129 = 1;
...
for (_i = (int) (0); (step129 > 0 && _i <= limit129) || (step129 < 0 && _i >= limit129); _i = ((int)(0 + _i + step129))) {
 //BA.debugLineNum = 168;BA.debugLine="CursorDBPoint.Position = i              '記錄指標從第1筆開始(索引為0)";
_cursordbpoint.setPosition(_i);
 //BA.debugLineNum = 169;BA.debugLine="For j=0 To CursorDBPoint.ColumnCount-1    '控制「欄位」的個數";
{
final int step131 = 1;
final int limit131 = (int) (_cursordbpoint.getColumnCount()-1);
for (_j = (int) (0); (step131 > 0 && _j <= limit131) || (step131 < 0 && _j >= limit131); _j = ((int)(0 + _j + step131))) {
 //BA.debugLineNum = 170;BA.debugLine="strSqlViewContent=strSqlViewContent & CursorDBPoint.GetString(CursorDBPoint.GetColumnName(j)) & \"    \"";
mostCurrent._strsqlviewcontent = mostCurrent._strsqlviewcontent+_cursordbpoint.GetString(_cursordbpoint.GetColumnName(_j))+"    ";
 }
};
 //BA.debugLineNum = 172;BA.debugLine="livCourse.AddSingleLine ((i+1) & \". \" & strSqlViewContent )   '顯示「每一筆記錄的內容」";
mostCurrent._livcourse.AddSingleLine(BA.NumberToString((_i+1))+". "+mostCurrent._strsqlviewcontent);
 //BA.debugLineNum = 173;BA.debugLine="strSqlViewContent =\"\"";
mostCurrent._strsqlviewcontent = "";
 }
};
 //BA.debugLineNum = 175;BA.debugLine="ToastMessageShow(\"目前的課程記錄共有: \" & CursorDBPoint.RowCount & \" 筆!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("目前的課程記錄共有: "+BA.NumberToString(_cursordbpoint.getRowCount())+" 筆!",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 176;BA.debugLine="lblResult.Text =\"===本學期開設課程清單( \" & CursorDBPoint.RowCount & \" 筆)===\"";
...
String _sql_query = "";
String _querycourno = "";
 //BA.debugLineNum = 134;BA.debugLine="Sub SpinQueryCourNo_ItemClick (Position As Int, Value As Object)";
 //BA.debugLineNum = 135;BA.debugLine="Dim SQL_Query As String";
_sql_query = "";
 //BA.debugLineNum = 136;BA.debugLine="Dim QueryCourNo As String =SpinQueryCourNo.SelectedItem";
_querycourno = mostCurrent._spinquerycourno.getSelectedItem();
 //BA.debugLineNum = 137;BA.debugLine="SQL_Query=\"Select * FROM 課程資料表\" & _ 	          \" Where 課號 = '\" & QueryCourNo & \"'\"";
_sql_query = "Select * FROM 課程資料表"+" Where 課號 = '"+_querycourno+"'";
 //BA.debugLineNum = 139;BA.debugLine="CallShow_CourseData(SQL_Query)    '呼叫顯示「課程資料表」之副程式";
_callshow_coursedata(_sql_query);
 //BA.debugLineNum = 140;BA.debugLine="SpinQueryCourNo.Visible =False    '查詢「課程代號」的下拉式元件隱藏";
mostCurrent._spinquerycourno.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 141;BA.debugLine="edtCourNo.Visible =True           '「課程代號」欄位元件顯示";
