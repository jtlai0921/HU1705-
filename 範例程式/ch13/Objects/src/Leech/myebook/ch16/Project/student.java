...
public class student extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "Leech.myebook.ch16.Project", "Leech.myebook.ch16.Project.student");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Leech.myebook.ch16.Project", "Leech.myebook.ch16.Project.student");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Leech.myebook.ch16.Project.student", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
mostCurrent._deptno = mostCurrent._spndeptno.getSelectedItem().substring((int) (0),(int) (4));
 //BA.debugLineNum = 70;BA.debugLine="If StudNo=\"\" OR StudName=\"\" OR DeptNo=\"\" Then";
if ((_studno).equals("") || (_studname).equals("") || (mostCurrent._deptno).equals("")) { 
...
_strsql = "INSERT INTO 學生資料表(學號,姓名,系碼)"+"VALUES('"+_studno+"','"+_studname+"','"+mostCurrent._deptno+"')";
 //BA.debugLineNum = 75;BA.debugLine="Check_StuID_Exists(StudNo)        '呼叫檢查「學號」是否有重複新增之副程式";
_check_stuid_exists(_studno);
 //BA.debugLineNum = 76;BA.debugLine="If Check_StuID_Exist=True Then    '檢查是否有重複新增";
if (_check_stuid_exist==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 77;BA.debugLine="Msgbox(\"您已經重複新增「學號」了！\",\"新增錯誤訊息!!!\")";
anywheresoftware.b4a.keywords.Common.Msgbox("您已經重複新增「學號」了！","新增錯誤訊息!!!",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 79;BA.debugLine="SQLCmd.ExecNonQuery(strSQL)                             '執行SQL指令，以成功的新增記錄";
_sqlcmd.ExecNonQuery(_strsql);
 //BA.debugLineNum = 80;BA.debugLine="ToastMessageShow(\"您新增成功「學生資料」記錄!\", True)   '顯示新增成功狀態";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("您新增成功「學生資料」記錄!",anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 82;BA.debugLine="Check_StuID_Exist=False                                   '設定沒有重複新增「學號」";
_check_stuid_exist = anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 84;BA.debugLine="QueryDBList(\"Select * FROM 學生資料表\")      '呼叫顯示目前存在的學生資料表之副程式";
_querydblist("Select * FROM 學生資料表");
...
{
final int step104 = 1;
final int limit104 = (int) (_cursordbpoint.getRowCount()-1);
...
mostCurrent._spndeptno.Add(_cursordbpoint.GetString("系碼")+"/"+_cursordbpoint.GetString("系名"));
 }
};
...
public static String  _check_stuid_exists(String _strstudno) throws Exception{
String _sql_query = "";
 //BA.debugLineNum = 87;BA.debugLine="Sub Check_StuID_Exists(strStudNo As String)       '檢查「學號」是否有重複新增之副程式";
 //BA.debugLineNum = 88;BA.debugLine="Dim SQL_Query As String";
_sql_query = "";
 //BA.debugLineNum = 89;BA.debugLine="SQL_Query=\"Select * FROM 學生資料表 Where 學號='\" & strStudNo & \"' \"";
_sql_query = "Select * FROM 學生資料表 Where 學號='"+_strstudno+"' ";
 //BA.debugLineNum = 90;BA.debugLine="Msgbox(SQL_Query,\"SQL\")";
...
{
final int step134 = 1;
final int limit134 = (int) (_cursordbpoint.getColumnCount()-1);
...
{
final int step140 = 1;
final int limit140 = (int) (_cursordbpoint.getRowCount()-1);
...
{
final int step142 = 1;
final int limit142 = (int) (_cursordbpoint.getColumnCount()-1);
