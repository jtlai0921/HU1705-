...
public class department extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "Leech.myebook.ch16.Project", "Leech.myebook.ch16.Project.department");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Leech.myebook.ch16.Project", "Leech.myebook.ch16.Project.department");
        ...
        if (BA.shellMode) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Leech.myebook.ch16.Project.department", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
_querydblist("Select * FROM 科系代碼表");
...
String _deptno = "";
String _strsql = "";
 //BA.debugLineNum = 110;BA.debugLine="Sub btnDelete_Click   '刪除「科系代碼」資料";
 //BA.debugLineNum = 111;BA.debugLine="If edtDeptNo.Text=\"\" Then";
if ((mostCurrent._edtdeptno.getText()).equals("")) { 
 //BA.debugLineNum = 112;BA.debugLine="Msgbox(\"您尚未輸入「科系代碼」哦！\",\"錯誤訊息回報!!!\")";
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入「科系代碼」哦！","錯誤訊息回報!!!",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 114;BA.debugLine="Dim DeptNo As String =edtDeptNo.Text";
_deptno = mostCurrent._edtdeptno.getText();
 //BA.debugLineNum = 115;BA.debugLine="Dim strSQL As String";
_strsql = "";
 //BA.debugLineNum = 116;BA.debugLine="strSQL = \"DELETE FROM 科系代碼表 WHERE 系碼 = '\" & DeptNo & \"'\"";
_strsql = "DELETE FROM 科系代碼表 WHERE 系碼 = '"+_deptno+"'";
 //BA.debugLineNum = 117;BA.debugLine="SQLCmd.ExecNonQuery(strSQL)";
_sqlcmd.ExecNonQuery(_strsql);
 //BA.debugLineNum = 118;BA.debugLine="ToastMessageShow(\"刪除一筆「科系代碼」記錄...\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("刪除一筆「科系代碼」記錄...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 119;BA.debugLine="QueryDBList(\"Select * FROM 科系代碼表\")  '呼叫顯示目前存在的科系代碼表之副程式";
_querydblist("Select * FROM 科系代碼表");
 };
...
public static String  _btnexitdepartment_click() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub btnExitDepartment_Click";
 //BA.debugLineNum = 182;BA.debugLine="Activity.Finish()  '活動完成";
...
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未完整輸入「科系代碼」相關哦！","錯誤訊息回報!!!",mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 67;BA.debugLine="SQLCmd.BeginTransaction";
_sqlcmd.BeginTransaction();
 //BA.debugLineNum = 68;BA.debugLine="Try";
try { //BA.debugLineNum = 69;BA.debugLine="strSQL = \"INSERT INTO 科系代碼表(系碼,系名,系主任)\" & _              \"VALUES('\" & DeptNo & \"','\" & DeptName & \"','\" & DeptManager & \"')\"";
_strsql = "INSERT INTO 科系代碼表(系碼,系名,系主任)"+"VALUES('"+_deptno+"','"+_deptname+"','"+_deptmanager+"')";
 //BA.debugLineNum = 71;BA.debugLine="Check_DeptID_Exists(DeptNo)        '呼叫檢查「科系代碼」是否有重複新增之副程式";
_check_deptid_exists(_deptno);
 //BA.debugLineNum = 72;BA.debugLine="If Check_DeptID_Exist=True Then    '檢查是否有重複新增";
if (_check_deptid_exist==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 73;BA.debugLine="Msgbox(\"您已經重複新增「科系代碼」了！\",\"新增錯誤訊息!!!\")";
...
_sqlcmd.ExecNonQuery(_strsql);
 //BA.debugLineNum = 76;BA.debugLine="ToastMessageShow(\"您新增成功「科系代碼」記錄!\", True)   '顯示新增成功狀態";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("您新增成功「科系代碼」記錄!",anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 78;BA.debugLine="Check_DeptID_Exist=False           '設定沒有重複新增「科系代碼」";
_check_deptid_exist = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 79;BA.debugLine="QueryDBList(\"Select * FROM 科系代碼表\")  '呼叫顯示目前存在的科系代碼表之副程式";
_querydblist("Select * FROM 科系代碼表");
 //BA.debugLineNum = 80;BA.debugLine="SQLCmd.TransactionSuccessful";
_sqlcmd.TransactionSuccessful();
 } 
       catch (Exception e60) {
			processBA.setLastException(e60); //BA.debugLineNum = 82;BA.debugLine="Log(LastException.Message) 'no changes will be made";
...
public static String  _btnlistdata_click() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub btnListData_Click";
 //BA.debugLineNum = 179;BA.debugLine="QueryDBList(\"Select * FROM 科系代碼表\")  '呼叫顯示目前存在的科系代碼表之副程式";
_querydblist("Select * FROM 科系代碼表");
...
int _i = 0;
 //BA.debugLineNum = 123;BA.debugLine="Sub btnSelect_Click   '查詢「科系代碼」資料";
 //BA.debugLineNum = 124;BA.debugLine="SpinQueryDeptNo.Visible =True    '查詢「科系代碼」的下拉式元件顯示";
mostCurrent._spinquerydeptno.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 125;BA.debugLine="edtDeptNo.Visible =False         '「科系代碼」欄位元件隱藏";
mostCurrent._edtdeptno.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 127;BA.debugLine="SpinQueryDeptNo.Clear";
mostCurrent._spinquerydeptno.Clear();
 //BA.debugLineNum = 128;BA.debugLine="CursorDBPoint = SQLCmd.ExecQuery(\"SELECT 系碼 FROM 科系代碼表\")";
_cursordbpoint.setObject((android.database.Cursor)(_sqlcmd.ExecQuery("SELECT 系碼 FROM 科系代碼表")));
 //BA.debugLineNum = 129;BA.debugLine="For i = 0 To CursorDBPoint.RowCount - 1";
{
final int step101 = 1;
final int limit101 = (int) (_cursordbpoint.getRowCount()-1);
...
_cursordbpoint.setPosition(_i);
 //BA.debugLineNum = 131;BA.debugLine="SpinQueryDeptNo.Add(CursorDBPoint.GetString(\"系碼\"))";
mostCurrent._spinquerydeptno.Add(_cursordbpoint.GetString("系碼"));
 }
};
...
String _deptno = "";
String _strsql = "";
 //BA.debugLineNum = 96;BA.debugLine="Sub btnUpdate_Click   '修改「科系代碼」資料";
 //BA.debugLineNum = 97;BA.debugLine="If edtDeptNo.Text=\"\" Then";
if ((mostCurrent._edtdeptno.getText()).equals("")) { 
 //BA.debugLineNum = 98;BA.debugLine="Msgbox(\"您尚未輸入「科系代碼」哦！\",\"錯誤訊息回報!!!\")";
anywheresoftware.b4a.keywords.Common.Msgbox("您尚未輸入「科系代碼」哦！","錯誤訊息回報!!!",mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 100;BA.debugLine="Dim DeptNo As String =edtDeptNo.Text";
_deptno = mostCurrent._edtdeptno.getText();
 //BA.debugLineNum = 101;BA.debugLine="Dim strSQL As String";
_strsql = "";
 //BA.debugLineNum = 102;BA.debugLine="strSQL = \"UPDATE 科系代碼表 SET 系名 ='\" & edtDeptName.Text & \"'\" & _             \",系主任 ='\" & edtDeptManager.Text & \"'  WHERE 系碼 = '\" & DeptNo & \"'\"";
_strsql = "UPDATE 科系代碼表 SET 系名 ='"+mostCurrent._edtdeptname.getText()+"'"+",系主任 ='"+mostCurrent._edtdeptmanager.getText()+"'  WHERE 系碼 = '"+_deptno+"'";
 //BA.debugLineNum = 104;BA.debugLine="SQLCmd.ExecNonQuery(strSQL)";
_sqlcmd.ExecNonQuery(_strsql);
 //BA.debugLineNum = 105;BA.debugLine="ToastMessageShow(\"更新一筆「科系代碼」記錄...\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("更新一筆「科系代碼」記錄...",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 106;BA.debugLine="QueryDBList(\"Select * FROM 科系代碼表\")  '呼叫顯示目前存在的科系代碼表之副程式";
_querydblist("Select * FROM 科系代碼表");
 };
...
public static String  _callshow_deptdata(String _strsql) throws Exception{
 //BA.debugLineNum = 144;BA.debugLine="Sub CallShow_DeptData(strSQL As String)  '顯示「科系代碼表」之副程式";
...
_cursordbpoint.setPosition((int) (0));
 //BA.debugLineNum = 147;BA.debugLine="edtDeptNo.Text = CursorDBPoint.GetString(\"系碼\")";
mostCurrent._edtdeptno.setText((Object)(_cursordbpoint.GetString("系碼")));
 //BA.debugLineNum = 148;BA.debugLine="edtDeptName.Text=CursorDBPoint.GetString(\"系名\")";
mostCurrent._edtdeptname.setText((Object)(_cursordbpoint.GetString("系名")));
 //BA.debugLineNum = 149;BA.debugLine="edtDeptManager.Text=CursorDBPoint.GetString(\"系主任\")";
mostCurrent._edtdeptmanager.setText((Object)(_cursordbpoint.GetString("系主任")));
 //BA.debugLineNum = 150;BA.debugLine="End Sub";
return "";
}
public static String  _check_deptid_exists(String _strdeptno) throws Exception{
String _sql_query = "";
 //BA.debugLineNum = 87;BA.debugLine="Sub Check_DeptID_Exists(strDeptNo As String)  '檢查「科系代碼」是否有重複新增之副程式";
 //BA.debugLineNum = 88;BA.debugLine="Dim SQL_Query As String";
_sql_query = "";
 //BA.debugLineNum = 89;BA.debugLine="SQL_Query=\"Select * FROM 科系代碼表 Where 系碼='\" & strDeptNo & \"' \"";
_sql_query = "Select * FROM 科系代碼表 Where 系碼='"+_strdeptno+"' ";
 //BA.debugLineNum = 90;BA.debugLine="CursorDBPoint = SQLCmd.ExecQuery(SQL_Query)  '執行SQL指令，並回傳值";
_cursordbpoint.setObject((android.database.Cursor)(_sqlcmd.ExecQuery(_sql_query)));
 //BA.debugLineNum = 91;BA.debugLine="If CursorDBPoint.RowCount>0 Then  '檢查目前資料庫中的「科系代碼表」是否已經存在一筆了";
if (_cursordbpoint.getRowCount()>0) { 
 //BA.debugLineNum = 92;BA.debugLine="Check_DeptID_Exist=True        '代表重複新增「科系代碼」了!";
...
_cursordbpoint = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 9;BA.debugLine="Dim Check_DeptID_Exist As Boolean=False   '宣告檢查新增「科系代碼」時的代號是否重複，預設值為False";
_check_deptid_exist = anywheresoftware.b4a.keywords.Common.False;
...
int _i = 0;
int _j = 0;
 //BA.debugLineNum = 152;BA.debugLine="Sub QueryDBList(strSQLite As String) '顯示目前存在的科系代碼表之副程式";
 //BA.debugLineNum = 153;BA.debugLine="livDepartment.Clear '清單清空";
mostCurrent._livdepartment.Clear();
 //BA.debugLineNum = 154;BA.debugLine="strSqlViewTitle =\"\"";
mostCurrent._strsqlviewtitle = "";
 //BA.debugLineNum = 155;BA.debugLine="strSqlViewContent =\"\"";
mostCurrent._strsqlviewcontent = "";
 //BA.debugLineNum = 156;BA.debugLine="strLine =\"\"";
mostCurrent._strline = "";
 //BA.debugLineNum = 157;BA.debugLine="CursorDBPoint = SQLCmd.ExecQuery(strSQLite)";
_cursordbpoint.setObject((android.database.Cursor)(_sqlcmd.ExecQuery(_strsqlite)));
 //BA.debugLineNum = 158;BA.debugLine="livDepartment.SingleLineLayout.Label.TextSize=16";
mostCurrent._livdepartment.getSingleLineLayout().Label.setTextSize((float) (16));
 //BA.debugLineNum = 159;BA.debugLine="livDepartment.SingleLineLayout.ItemHeight = 20dip";
mostCurrent._livdepartment.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 160;BA.debugLine="For i = 0 To CursorDBPoint.ColumnCount-1    '取得「欄位名稱」";
{
final int step129 = 1;
final int limit129 = (int) (_cursordbpoint.getColumnCount()-1);
for (_i = (int) (0); (step129 > 0 && _i <= limit129) || (step129 < 0 && _i >= limit129); _i = ((int)(0 + _i + step129))) {
 //BA.debugLineNum = 161;BA.debugLine="strSqlViewTitle=strSqlViewTitle & CursorDBPoint.GetColumnName(i) & \"          \"";
mostCurrent._strsqlviewtitle = mostCurrent._strsqlviewtitle+_cursordbpoint.GetColumnName(_i)+"          ";
 //BA.debugLineNum = 162;BA.debugLine="strLine=strLine & \"=======\"              '設定「分隔水平線之每一小段的長度」";
mostCurrent._strline = mostCurrent._strline+"=======";
 }
};
 //BA.debugLineNum = 164;BA.debugLine="livDepartment.AddSingleLine (strSqlViewTitle)  '顯示「欄位名稱」";
mostCurrent._livdepartment.AddSingleLine(mostCurrent._strsqlviewtitle);
 //BA.debugLineNum = 165;BA.debugLine="livDepartment.AddSingleLine (strLine)          '顯示「分隔水平線」";
mostCurrent._livdepartment.AddSingleLine(mostCurrent._strline);
 //BA.debugLineNum = 166;BA.debugLine="For i = 0 To CursorDBPoint.RowCount - 1     '控制「記錄」的筆數";
{
final int step135 = 1;
final int limit135 = (int) (_cursordbpoint.getRowCount()-1);
for (_i = (int) (0); (step135 > 0 && _i <= limit135) || (step135 < 0 && _i >= limit135); _i = ((int)(0 + _i + step135))) {
 //BA.debugLineNum = 167;BA.debugLine="CursorDBPoint.Position = i              '記錄指標從第1筆開始(索引為0)";
_cursordbpoint.setPosition(_i);
 //BA.debugLineNum = 168;BA.debugLine="For j=0 To CursorDBPoint.ColumnCount-1    '控制「欄位」的個數";
{
final int step137 = 1;
final int limit137 = (int) (_cursordbpoint.getColumnCount()-1);
for (_j = (int) (0); (step137 > 0 && _j <= limit137) || (step137 < 0 && _j >= limit137); _j = ((int)(0 + _j + step137))) {
 //BA.debugLineNum = 169;BA.debugLine="strSqlViewContent=strSqlViewContent & CursorDBPoint.GetString(CursorDBPoint.GetColumnName(j)) & \"    \"";
mostCurrent._strsqlviewcontent = mostCurrent._strsqlviewcontent+_cursordbpoint.GetString(_cursordbpoint.GetColumnName(_j))+"    ";
 }
};
 //BA.debugLineNum = 171;BA.debugLine="livDepartment.AddSingleLine ((i+1) & \". \" & strSqlViewContent )   '顯示「每一筆記錄的內容」";
mostCurrent._livdepartment.AddSingleLine(BA.NumberToString((_i+1))+". "+mostCurrent._strsqlviewcontent);
 //BA.debugLineNum = 172;BA.debugLine="strSqlViewContent =\"\"";
mostCurrent._strsqlviewcontent = "";
 }
};
 //BA.debugLineNum = 174;BA.debugLine="ToastMessageShow(\"目前的科系記錄共有: \" & CursorDBPoint.RowCount & \" 筆!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow("目前的科系記錄共有: "+BA.NumberToString(_cursordbpoint.getRowCount())+" 筆!",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 175;BA.debugLine="lblResult.Text =\"===本校的科系清單共有( \" & CursorDBPoint.RowCount & \" 筆)===\"";
mostCurrent._lblresult.setText((Object)("===本校的科系清單共有( "+BA.NumberToString(_cursordbpoint.getRowCount())+" 筆)==="));
...
String _sql_query = "";
String _querydeptno = "";
 //BA.debugLineNum = 135;BA.debugLine="Sub SpinQueryDeptNo_ItemClick (Position As Int, Value As Object)";
 //BA.debugLineNum = 136;BA.debugLine="Dim SQL_Query As String";
_sql_query = "";
 //BA.debugLineNum = 137;BA.debugLine="Dim QueryDeptNo As String =SpinQueryDeptNo.SelectedItem";
_querydeptno = mostCurrent._spinquerydeptno.getSelectedItem();
 //BA.debugLineNum = 138;BA.debugLine="SQL_Query=\"Select * FROM 科系代碼表 Where 系碼 = '\" & QueryDeptNo & \"'\"";
_sql_query = "Select * FROM 科系代碼表 Where 系碼 = '"+_querydeptno+"'";
 //BA.debugLineNum = 139;BA.debugLine="CallShow_DeptData(SQL_Query)";
_callshow_deptdata(_sql_query);
 //BA.debugLineNum = 140;BA.debugLine="SpinQueryDeptNo.Visible =False    '查詢「科系代碼」的下拉式元件隱藏";
mostCurrent._spinquerydeptno.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 141;BA.debugLine="edtDeptNo.Visible =True           '「科系代碼」欄位元件顯示";
